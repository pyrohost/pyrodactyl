...
namespace Pyrodactyl\Tests\Integration\Services\Allocations;

use Pyrodactyl\Models\Allocation;
use Pyrodactyl\Tests\Integration\IntegrationTestCase;
use Pyrodactyl\Services\Allocations\FindAssignableAllocationService;
use Pyrodactyl\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use Pyrodactyl\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('pyrodactyl.client_features.allocations.enabled', true);
        config()->set('pyrodactyl.client_features.allocations.range_start', 0);
        config()->set('pyrodactyl.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('pyrodactyl.client_features.allocations.range_start', 5000);
        config()->set('pyrodactyl.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('pyrodactyl.client_features.allocations.range_start', 5000);
        config()->set('pyrodactyl.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('pyrodactyl.client_features.allocations.range_start', 'hodor');
        config()->set('pyrodactyl.client_features.allocations.range_end', 10);
        ...
        config()->set('pyrodactyl.client_features.allocations.range_start', 10);
        config()->set('pyrodactyl.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('pyrodactyl.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
