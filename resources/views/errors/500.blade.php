  ...
  <body data-pyro-body style="background-color: #000000; height: 100%; width: 100%; margin: 0; padding: 0;">
    <div class='font-jakarta text-white w-full h-full min-h-fit flex gap-12 items-center p-8 max-w-3xl mx-auto'>
      <div class='flex flex-col gap-4 max-w-sm text-left'>
        ...
        <h1 class='text-[32px] font-extrabold leading-[98%] tracking-[-0.11rem]'>500: Internal Server Error</h1>
        <p class=''>
          Something went wrong on our end. Don't worry, it's not your fault. We're working to fix it as soon as possible. Here are some useful links:
        </p>
      ...
      <img alt='' class='w-64 rounded-2xl' height='256' src='https://media1.tenor.com/m/r9CMayXxoFYAAAAC/niko-oneshot.gif' width='256' loading='lazy' decoding='async' />
    </div>
  </body>
</html>