...
const ServerRouter = () => {
	...
	const isHighlightVisible = useMemo(() => {
		...
		const itemBottomRelativeToContainer =
			itemTopRelativeToContainer + itemHeight;
		...
		return (
			itemBottomRelativeToContainer > visibleTop &&
			itemTopRelativeToContainer < visibleBottom
		);
						...
						<MainSidebar className="hidden lg:flex lg:relative lg:shrink-0 w-[300px] bg-[#1a1a1a] flex flex-col h-screen">
							<div className="flex flex-row items-center justify-between h-8">
								...
								<DropdownMenu>
									...
									<DropdownMenuContent
										className="z-99999 select-none relative"
										sideOffset={8}
									>
										{rootAdmin && (
							...
							<div className="shrink-0">
								<div
									aria-hidden
									className="mt-8 mb-4 bg-[#ffffff33] min-h-[1px] w-full"
								></div>
								<StatBlock
									title="server"
