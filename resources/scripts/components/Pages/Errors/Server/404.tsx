...
import { Moon, SunMoon, LinkIcon, LucideMoon, LucideSun, ServerIcon, LucideServerOff } from 'lucide-react'
        ...
        <Card className="w-full max-w-md p-8 text-center dark:bg-black bg-white backdrop-blur-xl ">
          <CardContent className="space-y-6">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full ">
              <LucideServerOff className="h-12 w-12 text-black dark:text-white" />
            </div>
            <h1 className="text-6xl font-bold dark:text-white text-black">404</h1>
            <p className="text-lg text-black dark:text-zinc-300">
              This server doesn't exist anymore or the link is broken. 
            </p>
