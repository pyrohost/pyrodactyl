...
import PriceContainer from '@/components/dashboard/Shop/PriceContainer';
...
export default function AdminDashboard(): JSX.Element {
  ...
  return (
    ...
    >
            ...
            <div className="absolute inset-0 flex items-center justify-between p-6">
              ...
              <div className="hidden md:flex items-center space-x-4">
                <div className="dark:text-white text-black text-right z-50 !opacity-100">
                  <p className="text-2xl font-bold font-doto">{auth.user.coins}</p>
                  <p className="text-xl font-bold font-doto">Coin Balance.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        <h1 className='text-3xl py-4 font-bold '>Coin items</h1>
      </div>
