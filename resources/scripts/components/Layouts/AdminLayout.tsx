...
import { Home, UserIcon, Sun, Moon, Menu, Settings, LogOut, ChevronDown, BarChart3, Folder, Terminal, X, ChevronLeft, LucideUser, Users,  Database, Server, 
    Network, HardDrive, Box, Cpu,
    FileCode, User, 
    LucideLocate,
    LucideMap,
    LucideGlobe,
    LucideGlobe2} from 'lucide-react'
...
const menuItems = [
    ...
    },
    {
        ...
        label: "Servers",
        href: "/admin/servers",
        matchPath: "/admin/servers"
    },
    {
        icon: Network,
        label: "Nodes",
        href: "/admin/nodes",
        matchPath: "/admin/nodes"
    },
    {
        icon: Box,
        label: "Nests",
        href: "/admin/nests",
        matchPath: "/admin/nests"
    },
    
    {
        ...
        matchPath: "/admin/locations"
    },
    {
        icon: Database,
        label: "Databases",
        href: "/admin/databases",
        matchPath: "/admin/databases"
    },
    {
        icon: HardDrive,
        label: "Mounts",
        href: "/admin/mounts",
        matchPath: "/admin/mounts"
    },
...
export default function AdminLayout({ children, serverId, serverName, sidebarTab }: ServerManagementLayoutProps) {
                ...
                <CardContent className="flex-grow overflow-y-auto p-2 space-y-2">
                    {menuItems.map((item) => (
                        <MenuItem
                            ...
                            label={item.label}
                            href={item.href}
                            isActive={url.startsWith(item.matchPath)}
                            collapsed={isSidebarCollapsed}
                        />
                    ))}
                </CardContent>
