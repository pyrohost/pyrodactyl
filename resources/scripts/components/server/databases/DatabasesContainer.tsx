...
const DatabasesContainer = () => {
	...
	const submitDatabase = (
		...
		{ setSubmitting, resetForm }: FormikHelpers<DatabaseValues>,
	) => {
		...
		<ServerContentBlock title={"Databases"}>
			...
			>
				<p className="text-sm text-neutral-400 leading-relaxed">
					Create and manage MySQL databases for your server. Configure database
					access, manage users, and view connection details.
				</p>
			</MainPageHeader>
