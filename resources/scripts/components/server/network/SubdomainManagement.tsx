...
const CleanInput = React.forwardRef<
	HTMLInputElement,
...
const CleanSelect = React.forwardRef<
	HTMLSelectElement,
...
const SubdomainManagement = () => {
	...
	const checkAvailability = useCallback(
		async (subdomain: string, domainId: string) => {
			...
			if (
				...
				subdomainInfo.current_subdomain.attributes.subdomain ===
					subdomain.trim() &&
				...
				<div className="flex items-center justify-center py-12">
					<div className="flex flex-col items-center gap-3">
						...
						<p className="text-sm text-neutral-400">
							Loading subdomain configuration...
						</p>
					</div>
				</div>
			</div>
	...
	if (
		!subdomainInfo?.available_domains ||
		subdomainInfo.available_domains.length === 0
	) {
		return (
			<div className="bg-gradient-to-b from-[#ffffff08] to-[#ffffff05] border-[1px] border-[#ffffff12] rounded-xl p-6 shadow-sm">
				...
				<div className="flex flex-col items-center justify-center py-12">
					<div className="text-center">
						...
						<p className="text-sm text-zinc-400 max-w-sm">
							Contact your administrator to configure subdomain support for this
							server.
						</p>
					</div>
				</div>
