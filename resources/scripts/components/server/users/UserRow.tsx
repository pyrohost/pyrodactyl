...
const UserRow = ({ subuser }: Props) => {
	...
	return (
		<PageListItem>
			<div
				className={`w-10 h-10 rounded-full bg-white border-2 border-zinc-800 overflow-hidden hidden md:block`}
			>
			...
			<div className={`sm:ml-4 flex-1 overflow-hidden flex flex-col`}>
				...
				<p
					className={`mt-1 md:mt-0 text-xs text-zinc-400 truncate sm:text-left text-center`}
				>
