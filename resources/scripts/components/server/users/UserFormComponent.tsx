							...
							<div className="space-y-4">
								{Object.keys(permissions)
									...
									.map((key) => (
										<div
											key={key}
											className="border border-[#ffffff12] rounded-lg p-4"
										>
													...
													<button
														...
														onClick={() => {
															...
															const allSelected = categoryPermissions.every(
																(p) => values.permissions.includes(p),
															);
															if (allSelected) {
																setFieldValue(
																	"permissions",
											...
											<div className="grid grid-cols-1 md:grid-cols-2 gap-3">
												{Object.keys(permissions[key]?.keys ?? {}).map(
													(pkey) => (
														<PermissionRow
															...
															disabled={
																!canEditUser ||
																editablePermissions.indexOf(`${key}.${pkey}`) <
																	0
															}
														/>
													),
