		...
		>
			...
			<div className={`flex-col`}>
				{isAdmin ? (
					<>
						<p>
							This server has reached the maximum process, thread, or memory
							limit. Increasing{" "}
							<code className={`font-mono bg-zinc-900`}>
								container_pid_limit
							</code>{" "}
							in the Wings configuration,{" "}
							<code className={`font-mono bg-zinc-900`}>config.yml</code>, might
					...
					<>
						...
						<p className="mt-3">
							<code className={`font-mono bg-zinc-900`}>
								pthread_create failed, Possibly out of memory or
