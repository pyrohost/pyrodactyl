        ...
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                ...
                >
                    ...
                    >
                        <MainPageHeader
                            title={showOnlyAdmin ? t('server_titles.other_servers') : t('server_titles.your_servers')}
                        >
                            <div className='flex gap-4'>
                                ...
                                <TabsList>
                                    <TabsTrigger aria-label={t('home.view_list')} value='list'>
                                        <svg
                                            width='16'
                                            height='17'
                                            viewBox='0 0 16 17'
                                    ...
                                    <TabsTrigger aria-label={t('home.view_grid')} value='grid'>
                                        <svg
                                            width='16'
                                            height='17'
                                            viewBox='0 0 16 17'
                                            ...
                                            <div className='flex flex-col items-center justify-center py-12 px-4'>
                                                <div className='text-center'>
                                                    ...
                                                    <h3 className='text-lg font-medium text-zinc-200 mb-2'>
                                                        {showOnlyAdmin
                                                            ? t('home.no_others_found')
                                                            : t('home.no_servers_found')}
                                                    </h3>
                                                    <p className='text-sm text-zinc-400 max-w-sm'>
                                                        {showOnlyAdmin
                                                            ? t('home.no_display_servers')
                                                            : t('home.no_associated_servers')}
                                                    </p>
                                                </div>
                                            </div>
                                        )
