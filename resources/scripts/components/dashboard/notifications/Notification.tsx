...
import { Bell, Check, AlertCircle, Info, X, LucideAlertCircle, LucideCheckCircle } from "lucide-react"
    ...
    <Popover>
      ...
      <PopoverContent className="w-80 p-0" align="end">
        <div className="flex items-center justify-between px-4 py-2 border-b border-zinc-200 dark:border-zinc-700">
          ...
          <Button
            variant="ghost"
            onClick={() => router.post("/api/inerstia/notifications/purge/10", { preserveScroll: true })}
            size="sm"
