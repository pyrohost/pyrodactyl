...
const AccountApiContainer = () => {
    ...
    return (
        <PageContentBlock title={t('api.api_keys')}>
            ...
            {showCreateModal && (
                <Dialog.Confirm
                    ...
                    title={t('api.create_api_key')}
                    confirm={t('api.create_key')}
                    onConfirmed={() => {
            ...
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                ...
                >
                    <div className='bg-gradient-to-b from-[#ffffff08] to-[#ffffff05] border-[1px] border-[#ffffff12] rounded-xl p-4 sm:p-6 shadow-sm'>
                        ...
                        >
                            {t('api.all_using')} <Code>{deleteIdentifier}</Code> {t('api.key_invalidated')}
                        </Dialog.Confirm>
                        ...
                        {keys.length === 0 ? (
                            <div className='text-center py-12'>
                                ...
                                <h3 className='text-lg font-medium text-zinc-200 mb-2'>{t('api.no_api_keys')}</h3>
                                <p className='text-sm text-zinc-400 max-w-sm mx-auto'>
                                    {loading ? t('api.load_keys') : t('api.no_keys_created')}
                                </p>
                            </div>
                        ) : (
