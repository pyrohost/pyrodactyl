...
export const rawDataToServerBackup = ({
	...
	jobStartedAt: attributes.job_started_at
		? new Date(attributes.job_started_at)
		: null,
	jobLastUpdatedAt: attributes.job_last_updated_at
		? new Date(attributes.job_last_updated_at)
		: null,
