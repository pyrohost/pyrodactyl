    ...
    var AnsiUp = (() => {
        function AnsiUp() {
            ...
            this.htmlFormatter = {
                ...
                compose: (segments, instance) => segments.join(''),
            };
            this.textFormatter = {
                transform: (fragment, instance) => fragment.text,
                compose: (segments, instance) => segments.join(''),
            };
        ...
        AnsiUp.prototype.old_linkify = (txt) =>
            txt.replace(/(https?:\/\/[^\s]+)/gm, (str) => '<a href="' + str + '">' + str + '</a>');
