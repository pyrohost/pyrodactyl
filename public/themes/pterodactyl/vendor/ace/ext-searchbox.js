    ...
    (function () {
        (this.setEditor = function (e) {
            ...
            (this.$init = function () {
                ...
                s.addListener(e, 'mousedown', (e) => {
                    ...
                    s.addListener(e, 'click', (e) => {
                        ...
                        r && this[r]
                            ? this[r]()
                            : this.$searchBarKb.commands[r] && this.$searchBarKb.commands[r].exec(this),
                            s.stopPropagation(e);
                    }),
                    s.addCommandKeyListener(e, (e, n, r) => {
                        var i = a.keyCodeToString(r),
                            o = this.$searchBarKb.findKeyCommand(n, i);
                        o && o.exec && (o.exec(this), s.stopEvent(e));
                    }),
                    ...
                    s.addListener(this.searchInput, 'focus', () => {
                        (this.activeInput = this.searchInput), this.searchInput.value && this.highlight();
                    }),
                    s.addListener(this.replaceInput, 'focus', () => {
                        (this.activeInput = this.replaceInput), this.searchInput.value && this.highlight();
                    });
            }),
            ...
            this.$searchBarKb.bindKeys({
                ...
                'Ctrl-H|Command-Option-F': (e) => {
                    (e.replaceBox.style.display = ''), e.replaceInput.focus();
                },
                'Ctrl-G|Command-G': (e) => {
                    e.findNext();
                },
                'Ctrl-Shift-G|Command-Shift-G': (e) => {
                    e.findPrev();
                },
                esc: (e) => {
                    setTimeout(() => {
