define('ace/ext/menu_tools/element_generator', ['require', 'exports', 'module'], (e, t, n) => {
    (n.exports.createOption = (t) => {
        var n,
            r = document.createElement('option');
        for (n in t) Object.hasOwn(t, n) && (n === 'selected' ? r.setAttribute(n, t[n]) : (r[n] = t[n]));
        return r;
    }),
        (n.exports.createCheckbox = (t, n, r) => {
        ...
        (n.exports.createLabel = (t, n) => {
            var r = document.createElement('label');
            return r.setAttribute('for', n), (r.textContent = t), r;
        }),
        (n.exports.createSelection = (t, r, i) => {
    ...
    define('ace/ext/themelist', ['require', 'exports', 'module', 'ace/lib/fixoldbrowsers'], (e, t, n) => {
    ...
    define('ace/ext/menu_tools/get_set_functions', ['require', 'exports', 'module'], (e, t, n) => {
        n.exports.getSetFunctions = (t) => {
            ...
            return (
                ['renderer', 'session', 'editor'].forEach((e) => {
                    var t = r[e],
                        o = e;
                    for (var u in t)
                        s.indexOf(u) === -1 &&
    ...
    define(
        ...
        (e, t, n) => {
            ...
            n.exports.generateSettingsMenu = (n) => {
                function u() {
                    o.sort((e, t) => {
                        ...
                        Array.isArray(s)
                            ? ((o = r.createSelection(i, s, t)),
                              o.addEventListener('change', (t) => {
                                  try {
                                      n.menuOptions[t.target.id].forEach((e) => {
    ...
    define('ace/ext/menu_tools/overlay_page', ['require', 'exports', 'module', 'ace/lib/dom'], (e, t, n) => {
        var r = e('../../lib/dom'),
            i =
        ...
        r.importCssString(i),
            (n.exports.overlayPage = (t, n, i, s, o, u) => {
                function l(e) {
