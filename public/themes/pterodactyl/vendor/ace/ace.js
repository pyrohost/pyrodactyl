(() => {
					...
					return (
						...
						(() => {
							...
							for (var n = 2 ** t.length; n--; )
								e.KEY_MODS[n] =
									t.filter((t) => n & e.KEY_MODS[t]).join("-") + "-";
						})(),
						(e.KEY_MODS[0] = ""),
						(e.KEY_MODS[-1] = "input-"),
						e
	...
	define("ace/lib/useragent", ["require", "exports", "module"], (e, t, n) => {
		(t.OS = { LINUX: "LINUX", MAC: "MAC", WINDOWS: "WINDOWS" }),
			(t.getOS = () =>
				t.isMac ? t.OS.MAC : t.isLinux ? t.OS.LINUX : t.OS.WINDOWS);
				...
				(this.normalizeRules = function () {
					function i(s) {
						...
						for (var u = 0; u < o.length; u++) {
							...
							if (f) {
								var d = [u, 1].concat(f);
								a.noEscape && (d = d.filter((e) => !e.next)),
									o.splice.apply(o, d),
									u--;
							}
							a.keywordMap &&
				...
				(this.shiftRow = function (e) {
					...
					(this.addFold = function (e) {
						if (e.sameRow) {
							...
							this.folds.push(e),
								this.folds.sort(
									(e, t) => -e.range.compareEnd(t.start.row, t.start.column),
								),
						...
						var s = this.on("changeSelection", () => {
							...
							u = this.renderer.on("afterRender", () => {
								if (
									...
									t &&
									(this.isFocused() ||
										(this.searchBox && this.searchBox.isFocused()))
								) {
									var e = this.renderer,
			...
			(function () {
				(this.CHANGE_CURSOR = 1),
					...
					(this.setTheme = function (e, t) {
						...
						(this.$themeId = e),
							this._dispatchEvent("themeChange", { theme: e });
						if (!e || typeof e == "string") {
