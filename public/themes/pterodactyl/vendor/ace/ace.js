(() => {
    ...
    define('ace/lib/regexp', ['require', 'exports', 'module'], (e, t, n) => {
        function o(e) {
            return (
                (e.global ? 'g' : '') +
                (e.ignoreCase ? 'i' : '') +
    ...
    define('ace/lib/es5-shim', ['require', 'exports', 'module'], (e, t, n) => {
        function r() {}
        function w(e) {
            try {
        ...
        Array.isArray || (Array.isArray = (t) => a(t) == '[object Array]');
        var m = Object('a'),
            g = m[0] != 'a' || !(0 in m);
        ...
        Object.getPrototypeOf ||
            (Object.getPrototypeOf = (t) => t.__proto__ || (t.constructor ? t.constructor.prototype : o));
        ...
        Object.getOwnPropertyNames || (Object.getOwnPropertyNames = (t) => Object.keys(t));
        if (!Object.create) {
            var b;
        ...
        Object.preventExtensions || (Object.preventExtensions = (t) => t),
            Object.isSealed || (Object.isSealed = (t) => !1),
            Object.isFrozen || (Object.isFrozen = (t) => !1),
            Object.isExtensible ||
    ...
    define('ace/lib/dom', ['require', 'exports', 'module'], (e, t, n) => {
        var r = 'http://www.w3.org/1999/xhtml';
        (t.getDocumentHead = (e) => (
            e || (e = document), e.head || e.getElementsByTagName('head')[0] || e.documentElement
        )),
            (t.createElement = (e, t) =>
                document.createElementNS ? document.createElementNS(t || r, e) : document.createElement(e)),
            (t.hasCssClass = (e, t) => {
        ...
        window.pageYOffset !== undefined
            ? ((t.getPageScrollTop = () => window.pageYOffset), (t.getPageScrollLeft = () => window.pageXOffset))
            : ((t.getPageScrollTop = () => document.body.scrollTop),
              (t.getPageScrollLeft = () => document.body.scrollLeft)),
            window.getComputedStyle
                ? (t.computedStyle = (e, t) =>
                      t ? (window.getComputedStyle(e, '') || {})[t] || '' : window.getComputedStyle(e, '') || {})
                : (t.computedStyle = (e, t) => (t ? e.currentStyle[t] : e.currentStyle)),
            (t.setInnerHtml = (e, t) => {
                var n = e.cloneNode(!1);
            ...
            'textContent' in document.documentElement
                ? ((t.setInnerText = (e, t) => {
                  ...
                  (t.getInnerText = (e) => e.textContent))
                : ((t.setInnerText = (e, t) => {
                      e.innerText = t;
                  }),
                  (t.getInnerText = (e) => e.innerText)),
            (t.getParentWindow = (e) => e.defaultView || e.parentWindow);
    }),
    define('ace/lib/oop', ['require', 'exports', 'module'], (e, t, n) => {
        (t.inherits = (e, t) => {
            (e.super_ = t),
    ...
    define('ace/lib/keys', ['require', 'exports', 'module', 'ace/lib/fixoldbrowsers', 'ace/lib/oop'], (e, t, n) => {
        e('./fixoldbrowsers');
        var r = e('./oop'),
            i = (() => {
                var e = {
                ...
                return (
                    ...
                    (() => {
                        ...
                        for (var n = 2 ** t.length; n--; )
                            e.KEY_MODS[n] = t.filter((t) => n & e.KEY_MODS[t]).join('-') + '-';
                    })(),
                    (e.KEY_MODS[0] = ''),
                    (e.KEY_MODS[-1] = 'input-'),
                    e
    ...
    define('ace/lib/useragent', ['require', 'exports', 'module'], (e, t, n) => {
        (t.OS = { LINUX: 'LINUX', MAC: 'MAC', WINDOWS: 'WINDOWS' }),
            (t.getOS = () => (t.isMac ? t.OS.MAC : t.isLinux ? t.OS.LINUX : t.OS.WINDOWS));
    ...
    define('ace/lib/event', ['require', 'exports', 'module', 'ace/lib/keys', 'ace/lib/useragent'], (e, t, n) => {
        function a(e, t, n) {
            var a = u(t);
            if (!i.isMac && s) {
        ...
        (t.addListener = (e, t, n) => {
            ...
            (t.addTouchMoveListener = (e, n) => {
                if ('ontouchmove' in e) {
                    var r, i;
                    t.addListener(e, 'touchstart', (e) => {
                        var t = e.changedTouches[0];
                        (r = t.clientX), (i = t.clientY);
                    }),
                        t.addListener(e, 'touchmove', (e) => {
                            var t = 1,
            ...
            (t.addMouseWheelListener = (e, n) => {
                'onmousewheel' in e
                    ? t.addListener(e, 'mousewheel', (e) => {
                          var t = 8;
                    ...
                    : 'onwheel' in e
                      ...
                      : t.addListener(e, 'DOMMouseScroll', (e) => {
            ...
            (t.addMultiMouseDownListener = (e, n, r, s) => {
                function c(e) {
        ...
        var u =
            !i.isMac || !i.isOpera || 'KeyboardEvent' in window
                ? (e) => 0 | (e.ctrlKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.shiftKey ? 4 : 0) | (e.metaKey ? 8 : 0)
                : (e) => 0 | (e.metaKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.shiftKey ? 4 : 0) | (e.ctrlKey ? 8 : 0);
        (t.getModifierString = (e) => r.KEY_MODS[u(e)]),
            (t.addCommandKeyListener = (e, n) => {
                var r = t.addListener;
    ...
    define('ace/lib/lang', ['require', 'exports', 'module'], (e, t, n) => {
        ...
        (e, t, n) => {
            var r = e('../lib/event'),
                ...
                f = function (e, t) {
                    ...
                    r.addListener(n, 'blur', (e) => {
                        t.onBlur(e), (v = !1);
                    }),
                        r.addListener(n, 'focus', (e) => {
                            (v = !0), t.onFocus(e), b();
                        }),
                        (this.focus = () => {
                            if (p) return n.focus();
                    ...
                    i.isWebKit ||
                        ...
                        w(),
                        v && t.onFocus();
                    var E = (e) => e.selectionStart === 0 && e.selectionEnd === e.value.length;
                    !n.setSelectionRange &&
                        n.createTextRange &&
    ...
    define('ace/tooltip', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/dom'], (e, t, n) => {
        function s(e) {
    ...
    define(
        ...
        (e, t, n) => {
            function u(e) {
                ...
                var o, u, f;
                e.editor.setDefaultHandler('guttermousemove', (t) => {
                    ...
                    s.addListener(t.renderer.$gutter, 'mouseout', (e) => {
                        u = null;
                        if (!f || o) return;
                        o = setTimeout(() => {
                            (o = null), c();
    ...
    define(
        ...
        (e, t, n) => {
            function f(e) {
                ...
                function M(e) {
                    var t = e.types;
                    return !t || Array.prototype.some.call(t, (e) => e == 'text/plain' || e == 'Text');
                }
                function _(e) {
                ...
                (this.onDragStart = function (e) {
                    if (this.cancelDrag || !c.draggable) {
                        return (
                            setTimeout(() => {
                                this.startSelect(), this.captureMouse(e);
                            }, 0),
                            e.preventDefault()
                        );
                    }
    ...
    define('ace/lib/net', ['require', 'exports', 'module', 'ace/lib/dom'], (e, t, n) => {
        var r = e('./dom');
        (t.get = (e, t) => {
    ...
    define('ace/lib/event_emitter', ['require', 'exports', 'module'], (e, t, n) => {
        var r = {},
            i = function () {
        ...
        (e, t, n) => {
            ...
            (function () {
                r.implement(this, i),
                    ...
                    (this.resetOptions = (e) => {
                        Object.keys(e.$options).forEach((t) => {
                            var n = e.$options[t];
    ...
    define(
        ...
        (e, t, n) => {
            ...
            (t.get = (e) => {
                if (!Object.hasOwn(a, e)) throw new Error('Unknown config key: ' + e);
                return a[e];
            }),
                (t.set = (e, t) => {
                    if (!Object.hasOwn(a, e)) throw new Error('Unknown config key: ' + e);
                ...
                (t.setModuleUrl = (e, t) => (a.$moduleUrls[e] = t)),
                (t.$loading = {}),
                (t.loadModule = (n, r) => {
                    var i, o;
            ...
            var r = e('../lib/event'),
                ...
                l = function (e) {
                    ...
                    r.addListener(f, 'mousedown', this.onMouseEvent.bind(this, 'guttermousedown')),
                        ...
                        e.on('mousemove', (n) => {
                            if (this.state || this.$dragDelay || !this.$dragEnabled) return;
            ...
            (function () {
                (this.onMouseEvent = function (e, t) {
                    ...
                    (this.captureMouse = function (e, t) {
                        ...
                        var o = (e) => {
                                if (!e) return;
                                if (i.isWebKit && !e.which && this.releaseMouse) return this.releaseMouse();
                                (this.x = e.clientX),
                                    (this.y = e.clientY),
                                    t && t(e),
                                    (this.mouseEvent = new u(e, this.editor)),
                                    (this.$mouseMoved = !0);
                            },
                            a = (e) => {
                                clearInterval(l),
                                    f(),
                                    this[this.state + 'End'] && this[this.state + 'End'](e),
                                    (this.state = ''),
                                    n.$keepTextAreaAtCursor == null &&
                                        ((n.$keepTextAreaAtCursor = !0), n.$moveTextAreaToCursor()),
                                    (this.isMousePressed = !1),
                                    (this.$onCaptureMouseMove = this.releaseMouse = null),
                                    e && this.onMouseEvent('mouseup', e);
                            },
                            f = () => {
                                this[this.state] && this[this.state](), (this.$mouseMoved = !1);
                            };
                        if (i.isOldIE && e.domEvent.type == 'dblclick')
                            return setTimeout(() => {
                                a(e);
                            });
                        (this.$onCaptureMouseMove = o), (this.releaseMouse = r.capture(this.editor.container, o, a));
    ...
    define('ace/mouse/fold_handler', ['require', 'exports', 'module'], (e, t, n) => {
        function r(e) {
            e.on('click', (t) => {
    ...
    define('ace/keyboard/keybinding', ['require', 'exports', 'module', 'ace/lib/keys', 'ace/lib/event'], (e, t, n) => {
        var r = e('../lib/keys'),
            i = e('../lib/event'),
            s = function (e) {
                (this.$editor = e),
            ...
            (this.setDefaultHandler = function (e) {
                ...
                (this.getStatusText = function () {
                    ...
                    return this.$handlers
                        .map((n) => (n.getStatusText && n.getStatusText(t, e)) || '')
                        .filter(Boolean)
                        .join(' ');
                }),
    ...
    define('ace/range', ['require', 'exports', 'module'], (e, t, n) => {
        ...
        (function () {
            ...
            (i.fromPoints = (e, t) => new i(e.row, e.column, t.row, t.column)),
            (i.comparePoints = r),
            (i.comparePoints = (e, t) => e.row - t.row || e.column - t.column),
            (t.Range = i);
    }),
    define(
        'ace/selection',
                ...
                u = function (e) {
                    ...
                    this.lead.on('change', (e) => {
                        this._emit('changeCursor'),
                            this.$isEmpty || this._emit('changeSelection'),
                            !this.$keepDesiredColumnOnChange &&
    ...
    define('ace/tokenizer', ['require', 'exports', 'module', 'ace/config'], (e, t, n) => {
        var r = e('./config'),
            i = 2e3,
            s = function (e) {
                ...
                for (var t in this.states) {
                    ...
                    for (var a = 0; a < n.length; a++) {
                        ...
                        Array.isArray(f.token)
                            ...
                            c > 1 &&
                                (/\\\d/.test(f.regex)
                                    ? (l = f.regex.replace(/\\([0-9]+)/g, (e, t) => '\\' + (parseInt(t, 10) + i + 1)))
        ...
        (function () {
            (this.$setMaxTokenCount = (e) => {
                ...
                (this.removeCapturingGroups = (e) => {
                    var t = e.replace(/\[(?:\\.|[^\]])*?\]|\\.|\(\?[:=!]|(\()/g, (e, t) => (t ? '(?:' : e));
                    return t;
                }),
                (this.createSplitterRegexp = (e, t) => {
                    if (e.indexOf('(?=') != -1) {
                        var n = 0,
                            r = !1,
                            i = {};
    ...
    define('ace/mode/text_highlight_rules', ['require', 'exports', 'module', 'ace/lib/lang'], (e, t, n) => {
        var r = e('../lib/lang'),
            i = function () {
                this.$rules = {
            ...
            (this.normalizeRules = function () {
                function i(s) {
                    ...
                    for (var u = 0; u < o.length; u++) {
                        ...
                        if (f) {
                            var d = [u, 1].concat(f);
                            a.noEscape && (d = d.filter((e) => !e.next)), o.splice.apply(o, d), u--;
                        }
                        a.keywordMap &&
    ...
    define('ace/mode/behaviour', ['require', 'exports', 'module'], (e, t, n) => {
        var r = function () {
            this.$behaviours = {};
        };
        (function () {
    ...
    define('ace/token_iterator', ['require', 'exports', 'module'], (e, t, n) => {
    ...
    define(
        ...
        (e, t, n) => {
            var r = e('../../lib/oop'),
                ...
                p = function () {
                    this.add('braces', 'insertion', function (e, t, n, r, i) {
                        ...
                        this.add('braces', 'deletion', (e, t, n, r, i) => {
                        ...
                        this.add('parens', 'insertion', (e, t, n, r, i) => {
                            if (i == '(') {
                                c(n);
                        ...
                        this.add('parens', 'deletion', (e, t, n, r, i) => {
                            var s = r.doc.getTextRange(i);
                            if (!i.isMultiLine() && s == '(') {
                                c(n);
                                var o = r.doc.getLine(i.start.row),
                        ...
                        this.add('brackets', 'insertion', (e, t, n, r, i) => {
                            if (i == '[') {
                                c(n);
                                var s = n.getSelectionRange(),
                                    o = r.doc.getTextRange(s);
                        ...
                        this.add('brackets', 'deletion', (e, t, n, r, i) => {
                            var s = r.doc.getTextRange(i);
                            if (!i.isMultiLine() && s == '[') {
                                c(n);
                                var o = r.doc.getLine(i.start.row),
                        ...
                        this.add('string_dquotes', 'deletion', (e, t, n, r, i) => {
                            var s = r.doc.getTextRange(i);
            ...
            (p.isSaneInsertion = function (e, t) {
                ...
                (p.$matchTokenType = (e, t) => t.indexOf(e.type || e) > -1),
    ...
    define('ace/unicode', ['require', 'exports', 'module'], (e, t, n) => {
        function r(e) {
            var n = /\w{4}/g;
        ...
        (e, t, n) => {
            ...
            (function () {
                (this.$defaultBehaviour = new s()),
                    ...
                    (this.checkOutdent = (e, t, n) => !1),
                    (this.autoOutdent = (e, t, n) => {}),
    ...
    define('ace/apply_delta', ['require', 'exports', 'module'], (e, t, n) => {
        function r(e, t) {
    ...
    define('ace/anchor', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/event_emitter'], (e, t, n) => {
        var r = e('./lib/oop'),
        ...
        (e, t, n) => {
            ...
            (function () {
                r.implement(this, s),
                    ...
                    (this.clonePos = (e) => ({ row: e.row, column: e.column })),
                    (this.pos = (e, t) => ({ row: e, column: t })),
                ...
                s = function (e, t) {
                    ...
                    this.$worker = () => {
                        ...
                        var e = new Date(),
                            ...
                            i = this.doc,
                            s = t;
                        while (this.lines[t]) t++;
                        var o = i.getLength(),
                            u = 0;
                        this.running = !1;
                        while (t < o) {
                            this.$tokenizeRow(t), (r = t);
                            do t++;
                            while (this.lines[t]);
                            u++;
                        ...
                        (this.currentLine = t), s <= r && this.fireUpdateEvent(s, r);
                    };
                };
            (function () {
                r.implement(this, i),
                    ...
                    (this.update = function (e, t, n, i) {
                        ...
                        for (var a = o; a <= u; a++) {
                            ...
                            f == null &&
                                ...
                                (f = f.map((e) => new s(a, e.offset, a, e.offset + e.length))),
    ...
    define('ace/edit_session/fold_line', ['require', 'exports', 'module', 'ace/range'], (e, t, n) => {
        function i(e, t) {
            ...
            (this.shiftRow = function (e) {
                ...
                (this.addFold = function (e) {
                    if (e.sameRow) {
                        ...
                        this.folds.push(e),
                            this.folds.sort((e, t) => -e.range.compareEnd(t.start.row, t.start.column)),
    ...
    define('ace/range_list', ['require', 'exports', 'module', 'ace/range'], (e, t, n) => {
        var r = e('./range').Range,
            i = r.comparePoints,
            s = function () {
                this.ranges = [];
            ...
            function u() {
                (this.getFoldAt = function (e, t, n) {
                    ...
                    (this.$cloneFoldData = function () {
                        var e = [];
                        return (
                            (e = this.$foldData.map((t) => {
                                var n = t.folds.map((e) => e.clone());
                                return new i(e, n);
                            })),
                            e
                        );
                ...
                r.implement(this, o),
                        ...
                        if (e) {
                            (this.$syncInformUndoManager = () => {
                                this.$informUndoManager.cancel(),
                                    this.$deltasFold.length &&
                                        (this.$deltas.push({
                                            group: 'fold',
                                            deltas: this.$deltasFold,
                                        }),
                                        (this.$deltasFold = [])),
                                    this.$deltasDoc.length &&
                                        (this.$deltas.push({
                                            group: 'doc',
                                    ...
                                    this.$deltas.length > 0 &&
                                        e.execute({
                                            action: 'aceupdate',
                                            args: [this.$deltas, this],
                                            merge: this.mergeUndoDeltas,
                                        }),
                                    (this.mergeUndoDeltas = !1),
                                    (this.$deltas = []);
                            }),
                    ...
                    (this.$moveLines = function (e, t, n) {
                        ...
                        var s = new f(e, 0, t, Number.MAX_VALUE),
                            o = this.getFoldsInRange(s).map(
                                (e) => ((e = e.clone()), (e.start.row += i), (e.end.row += i), e),
                            ),
                    ...
                    (this.$constrainWrapLimit = (e, t, n) => (t && (e = Math.max(t, e)), n && (e = Math.min(n, e)), e)),
    ...
    define('ace/search', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/lib/oop', 'ace/range'], (e, t, n) => {
        function u(e, t) {
            function n(e) {
        ...
        (function () {
            (this.set = function (e) {
                ...
                (this.$assembleMultilineRegExp = (e, t) => {
                    var n = e.replace(/\r\n|\r|\n/g, '$\n^').split('\n'),
                        r = [];
                    for (var i = 0; i < n.length; i++)
                        try {
            ...
            (u.prototype = o.prototype),
                function () {
                    ...
                    (this.addCommand = function (e) {
                        ...
                        (this.getStatusText = (e, t) => t.$keyChain || '');
                }.call(o.prototype),
                (t.HashHandler = o),
            ...
            r.inherits(o, i),
                function () {
                    r.implement(this, s),
                        ...
                        (this.trimMacro = (e) =>
                            e.map((e) => (typeof e[0] != 'string' && (e[0] = e[0].name), e[1] || (e = e[0]), e)));
                }.call(o.prototype),
                (t.CommandManager = o);
        },
    ),
            ...
            t.commands = [
                {
                    ...
                    exec: (e) => {
                        i.loadModule('ace/ext/settings_menu', (t) => {
                ...
                },
                {
                    ...
                    bindKey: o('Alt-E', 'F4'),
                    exec: (e) => {
                        i.loadModule('ace/ext/error_marker', (t) => {
                ...
                r.implement(this, d),
                    ...
                    (this.setKeyboardHandler = function (e, t) {
                        if (e && typeof e == 'string') {
                            this.$keybindingId = e;
                            g.loadModule(['keybinding', e], (r) => {
                                this.$keybindingId == e && this.keyBinding.setKeyboardHandler(r && r.handler), t && t();
                            });
                    ...
                    (this.$highlightBrackets = function () {
                        ...
                        (this.$highlightPending = !0),
                            setTimeout(() => {
                                this.$highlightPending = !1;
                                var t = this.session;
                                if (!t || !t.bgTokenizer) return;
                                var n = t.findMatchingBracket(this.getCursorPosition());
                                if (n) var r = new p(n.row, n.column, n.row, n.column + 1);
                                else if (t.$mode.getMatching) var r = t.$mode.getMatching(this.session);
                    ...
                    (this.sortLines = function () {
                        ...
                        n.sort((e, t) =>
                            e.toLowerCase() < t.toLowerCase() ? -1 : e.toLowerCase() > t.toLowerCase() ? 1 : 0,
                        );
                        var r = new p(0, 0, 0, 0);
                    ...
                    (this.modifyNumber = function (e) {
                        ...
                        if (!isNaN(parseFloat(i)) && isFinite(i)) {
                            ...
                            if (s) {
                                ...
                                (a *= 10 ** u),
                                    o !== s.end && n < o ? (e *= 10 ** (s.end - n - 1)) : (e *= 10 ** (s.end - n)),
                                    (a += e),
                                    (a /= 10 ** u);
                                var f = a.toFixed(u),
                    ...
                    (this.setAutoScrollEditorIntoView = function (e) {
                        ...
                        var s = this.on('changeSelection', () => {
                            ...
                            o = this.renderer.on('beforeRender', () => {
                                r && (t = this.renderer.container.getBoundingClientRect());
                            }),
                            u = this.renderer.on('afterRender', () => {
                                if (r && t && (this.isFocused() || (this.searchBox && this.searchBox.isFocused()))) {
                                    var e = this.renderer,
    ...
    define('ace/undomanager', ['require', 'exports', 'module'], (e, t, n) => {
        var r = function () {
            this.reset();
        };
        (function () {
            ...
            (this.execute = function (e) {
                ...
                (this.$serializeDeltas = (t) => n(t, e)),
                (this.$deserializeDeltas = (e) => n(e, t));
        }).call(r.prototype),
            (t.UndoManager = r);
    }),
    define(
    ...
    define('ace/layer/marker', ['require', 'exports', 'module', 'ace/range', 'ace/lib/dom'], (e, t, n) => {
        var r = e('../range').Range,
            i = e('../lib/dom'),
            s = function (e) {
                (this.element = i.createElement('div')),
        ...
        (function () {
            ...
            (this.$padding = 0),
                ...
                (this.$getTop = (e, t) => (e - t.firstRowScreen) * t.lineHeight),
                    ...
                    (this.$renderToken = function (e, t, n, r) {
                        var o =
                            ...
                            u = (e, n, r, o, u) => {
                                if (n)
                                    return this.showInvisibles
                                        ? "<span class='ace_invisible ace_invisible_space'>" +
                                              s.stringRepeat(this.SPACE_CHAR, e.length) +
                                              '</span>'
                                        : e;
                                if (e == '&') return '&#38;';
                                if (e == '<') return '&#60;';
                                if (e == '>') return '&#62;';
                                if (e == '	') {
                                    var a = this.session.getScreenTabSize(t + o);
                                    return (t += a - 1), this.$tabStrings[a];
                                }
                                if (e == '\u3000') {
                                    var f = this.showInvisibles
                                            ? 'ace_cjk ace_invisible ace_invisible_space'
                                            : 'ace_cjk',
                                        l = this.showInvisibles ? this.SPACE_CHAR : '';
                                    return (
                                        (t += 1),
                                        "<span class='" +
                                            f +
    ...
    define('ace/layer/cursor', ['require', 'exports', 'module', 'ace/lib/dom'], (e, t, n) => {
        var r = e('../lib/dom'),
            i,
            s = function (e) {
                (this.element = r.createElement('div')),
    ...
    define('ace/renderloop', ['require', 'exports', 'module', 'ace/lib/event'], (e, t, n) => {
        var r = e('./lib/event'),
            i = function (e, t) {
            ...
            this.schedule = function (e) {
                ...
                if (!this.pending && this.changes) {
                    ...
                    r.nextFrame(() => {
                        this.pending = !1;
                        var e;
                        while ((e = this.changes)) (this.changes = 0), this.onRender(e);
                    }, this.window);
                }
            };
        }).call(i.prototype),
            ...
            var g = function (e, t) {
                ...
                (this.canvas = r.element),
                    ...
                    this.scrollBarV.addEventListener('scroll', (e) => {
                        this.$scrollAnimation || this.session.setScrollTop(e.data - this.scrollMargin.top);
                    }),
                    this.scrollBarH.addEventListener('scroll', (e) => {
                        this.$scrollAnimation || this.session.setScrollLeft(e.data - this.scrollMargin.left);
                    }),
                    (this.scrollTop = 0),
                    (this.scrollLeft = 0),
                    ...
                    this.$textLayer.addEventListener('changeCharacterSize', (e) => {
                        this.updateCharacterSize(),
                            this.onResize(!0, this.gutterWidth, this.$size.width, this.$size.height),
                            this._signal('changeCharacterSize', e);
                    }),
                    (this.$size = {
                        width: 0,
            ...
            (function () {
                (this.CHANGE_CURSOR = 1),
                    ...
                    (this.animateScrolling = function (e, t) {
                        ...
                        var s = this.$calcSteps(e, n);
                        (this.$scrollAnimation = { from: e, to: n, steps: s }),
                            clearInterval(this.$timer),
                            this.session.setScrollTop(s.shift()),
                            (this.session.$scrollTop = n),
                            (this.$timer = setInterval(() => {
                                s.length
                                    ? (this.session.setScrollTop(s.shift()), (this.session.$scrollTop = n))
                                    : n != null
                                      ? ((this.session.$scrollTop = -1), this.session.setScrollTop(n), (n = null))
                    ...
                    (this.setTheme = function (e, t) {
                        ...
                        (this.$themeId = e), this._dispatchEvent('themeChange', { theme: e });
                        if (!e || typeof e == 'string') {
        ...
        (e, t, n) => {
            ...
            (function () {
                r.implement(this, s),
                    ...
                    (this.$normalizePath = (e) => i.qualifyURL(e)),
            ...
            var a = function (e, t, n) {
                ...
                (this.$worker = {}),
                    ...
                    (this.$worker.postMessage = (e) => {
                        this.messageBuffer.push(e), r && (i ? setTimeout(f) : f());
                    }),
                    (this.setEmitSync = (e) => {
                        i = e;
                    });
                var f = () => {
                    var e = this.messageBuffer.shift();
                ...
                (u.postMessage = (e) => {
                    ...
                    o.loadModule(['worker', t], (e) => {
                        r = new e[n](u);
                        while (this.messageBuffer.length) f();
                    });
            };
                ...
                s.implement(this, i),
                    (this.setup = function () {
                        ...
                        (i.$insertRight = !0),
                            ...
                            (this.others = []),
                            this.$others.forEach((n) => {
                                var r = t.createAnchor(n.row, n.column);
                                (r.$insertRight = !0), r.detach(), this.others.push(r);
                            }),
                            n.setUndoSelect(!1);
                    }),
                        ...
                        (this.othersActive = !0),
                            this.others.forEach((n) => {
                                n.markerId = e.addMarker(
                                    new r(n.row, n.column, n.row, n.column + this.length),
                                    this.othersClass,
                                    null,
                                    !1,
                                );
                ...
                (t.multiSelectCommands = [
                    {
                        ...
                        scrollIntoView: 'cursor',
                        readOnly: !0,
                        isAvailable: (e) => e && e.inMultiSelectMode,
                    },
                ]);
    ...
    define('ace/mode/folding/fold_mode', ['require', 'exports', 'module', 'ace/range'], (e, t, n) => {
        var r = e('../../range').Range,
            i = (t.FoldMode = () => {});
        (function () {
            (this.foldingStartMarker = null),
                ...
                (this.getFoldWidgetRange = (e, t, n) => null),
                (this.indentationBlock = (e, t, n) => {
                    var i = /\S/,
                        s = e.getLine(t),
                        o = s.search(i);
                    if (o == -1) return;
                ...
                (this.openingBracketBlock = (e, t, n, i, s) => {
    ...
    define('ace/theme/textmate', ['require', 'exports', 'module', 'ace/lib/dom'], (e, t, n) => {
        (t.isDark = !1),
            (t.cssClass = 'ace-tm'),
            (t.cssText =
...
(() => {
    window.require(['ace/ace'], (a) => {
        if (a) {
            a.config.init(true);
            a.define = window.define;
        }
        if (!window.ace) window.ace = a;
        for (var key in a) if (Object.hasOwn(a, key)) window.ace[key] = a[key];
    });
})();
