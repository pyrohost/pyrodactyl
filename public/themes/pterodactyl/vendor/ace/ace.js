(() => {
	...
	define("ace/lib/dom", ["require", "exports", "module"], (e, t, n) => {
		...
		(t.getDocumentHead = (e) => (
			...
			(t.createElement = (e, t) => document.createElementNS
		...
		window.pageYOffset !== undefined
			? ((t.getPageScrollTop = () => window.pageYOffset),
				(t.getPageScrollLeft = () => window.pageXOffset))
			: ((t.getPageScrollTop = () => document.body.scrollTop),
				(t.getPageScrollLeft = () => document.body.scrollLeft)),
			window.getComputedStyle
				? (t.computedStyle = (e, t) => t
		...
		(e, t, n) => {
			...
			function f(e) {
				...
				function M(e) {
					...
					return (
						!t ||
						Array.prototype.some.call(t, (e) => e == "text/plain" || e == "Text")
					);
				}
				function _(e) {
				...
				(this.onMouseEvent = function (e, t) {
					...
					(this.captureMouse = function (e, t) {
						...
						var 
							o = (e) => {
								if (!e) return;
								if (i.isWebKit && !e.which && this.releaseMouse)
						...
						(this.$onCaptureMouseMove = o),
							(this.releaseMouse = r.capture(this.editor.container, o, a));
			...
			(function () {
				(this.$defaultBehaviour = new s()),
					...
					(this.getCompletions = function (e, t, n, r) {
						...
						return i.map((e) => ({ name: e, value: e, score: 0, meta: "keyword" }));
					}),
				...
				(this.getFoldAt = function (e, t, n) {
					...
					(this.$addFoldLine = function (e) {
						return (
							...
							this.$foldData.sort((e, t) => e.start.row - t.start.row),
							e
						);
					}),
				...
				r.implement(this, o),
							...
							(this.$syncInformUndoManager = () => {
								this.$informUndoManager.cancel(),
									this.$deltasFold.length &&
										(this.$deltas.push({ group: "fold", deltas: this.$deltasFold }),
										(this.$deltasFold = [])),
									this.$deltasDoc.length &&
										(this.$deltas.push({ group: "doc", deltas: this.$deltasDoc }),
										(this.$deltasDoc = [])),
					...
					(this.$moveLines = function (e, t, n) {
						...
						var s = new f(e, 0, t, Number.MAX_VALUE),
							o = this.getFoldsInRange(s).map((e) => ((e = e.clone()), (e.start.row += i), (e.end.row += i), e)),
							u =
								n == 0
			...
			(function () {
				r.implement(this, d),
					...
					(this.setKeyboardHandler = function (e, t) {
						if (e && typeof e == "string") {
							...
							g.loadModule(["keybinding", e], (r) => {
								this.$keybindingId == e &&
									this.keyBinding.setKeyboardHandler(r && r.handler),
									t && t();
							});
						} else
						...
						(this.$highlightPending = !0),
							setTimeout(() => {
								...
								if (n) var r = new p(n.row, n.column, n.row, n.column + 1);
									...
									var r = t.$mode.getMatching(this.session);
								r &&
					...
					(this.sortLines = function () {
						...
						n.sort((e, t) => e.toLowerCase() < t.toLowerCase()
								? -1
						...
						var s = this.on("changeSelection", () => {
							...
							u = this.renderer.on("afterRender", () => {
								if (
									r &&
									t &&
									(this.isFocused() || (this.searchBox && this.searchBox.isFocused()))
								) {
									var e = this.renderer,
				...
				(this.canvas = r.element),
					...
					this.scrollBarV.addEventListener("scroll", (e) => {
						this.$scrollAnimation ||
							this.session.setScrollTop(e.data - this.scrollMargin.top);
					}),
					this.scrollBarH.addEventListener("scroll", (e) => {
						this.$scrollAnimation ||
							this.session.setScrollLeft(e.data - this.scrollMargin.left);
					}),
					(this.scrollTop = 0),
					(this.scrollLeft = 0),
