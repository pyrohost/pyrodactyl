...
((e) => {
    ...
    define('ace/mode/css/csslint', ['require', 'exports', 'module'], (require, exports, module) => {
        ...
        (() => {
            ...
            (e.prototype = {
                ...
                (r.fromToken = (e) => new r(e.value, e.startLine, e.startCol)),
                (r.prototype = {
                    constructor: r,
                    valueOf: function () {
                        return this.text;
                ...
                (i.createTokenData = (e) => {
                    ...
                    return (r.name = (e) => t[e]), (r.type = (e) => n[e]), r;
                }),
                (i.prototype = {
                    constructor: i,
                    match: function (e, t) {
            ...
            (() => {
                ...
                (Combinator.prototype = new SyntaxUnit()),
                    ...
                    (Parser.prototype = (() => {
                        ...
                        for (t in n) Object.hasOwn(n, t) && (e[t] = n[t]);
                        return e;
                    })());
                var Properties = {
                ...
                (PropertyName.prototype = new SyntaxUnit()),
                    ...
                    (PropertyValuePart.fromToken = (e) => new PropertyValuePart(e.value, e.startLine, e.startCol));
                var Pseudos = {
                    ':first-letter': 1,
                    ':first-line': 1,
                    ':before': 1,
                ...
                (Pseudos.ELEMENT = 1),
                    (Pseudos.CLASS = 2),
                    (Pseudos.isElement = (e) => e.indexOf('::') === 0 || Pseudos[e.toLowerCase()] == Pseudos.ELEMENT),
                ...
                (() => {
                    ...
                    (Tokens.name = (t) => e[t]), (Tokens.type = (e) => t[e] || -1);
                })();
                var Validation = {
                ...
                var ValidationTypes = {
                    ...
                    simple: {
                        ...
                        '<attachment>': (e) => ValidationTypes.isLiteral(e, 'scroll | fixed | local'),
                        '<attr>': (e) => e.type == 'function' && e.name == 'attr',
                        '<bg-image>': function (e) {
                        ...
                        '<box>': (e) => ValidationTypes.isLiteral(e, 'padding-box | border-box | content-box'),
                        '<content>': (e) => e.type == 'function' && e.name == 'content',
                        '<relative-size>': (e) => ValidationTypes.isLiteral(e, 'smaller | larger'),
                        '<ident>': (e) => e.type == 'identifier',
                        '<length>': (e) =>
                            e.type == 'function' && /^(?:-(?:ms|moz|o|webkit)-)?calc/i.test(e)
                                ? !0
                                : e.type == 'length' || e.type == 'number' || e.type == 'integer' || e == '0',
                        '<color>': (e) => e.type == 'color' || e == 'transparent',
                        '<number>': function (e) {
                            return e.type == 'number' || this['<integer>'](e);
                        },
                        '<integer>': (e) => e.type == 'integer',
                        '<line>': (e) => e.type == 'integer',
                        '<angle>': (e) => e.type == 'angle',
                        '<uri>': (e) => e.type == 'uri',
                        '<image>': function (e) {
                            return this['<uri>'](e);
                        },
                        '<percentage>': (e) => e.type == 'percentage' || e == '0',
                        ...
                        '<shape>': (e) => e.type == 'function' && (e.name == 'rect' || e.name == 'inset-rect'),
                        '<time>': (e) => e.type == 'time',
                        ...
                        '<flex-direction>': (e) =>
                            ValidationTypes.isLiteral(e, 'row | row-reverse | column | column-reverse'),
                        '<flex-wrap>': (e) => ValidationTypes.isLiteral(e, 'nowrap | wrap | wrap-reverse'),
                    },
                    complex: {
                        '<bg-position>': (e) => {
                            var n = !1,
        ...
        var util = {
            isArray: (e) => Array.isArray(e) || (typeof e == 'object' && objectToString(e) === '[object Array]'),
            isDate: (e) => typeof e == 'object' && objectToString(e) === '[object Date]',
            isRegExp: (e) => typeof e == 'object' && objectToString(e) === '[object RegExp]',
            getRegExpFlags: (e) => {
                var t = '';
        ...
        var CSSLint = (() => {
            ...
            return (
                ...
                (r.getRules = () => [].concat(e).sort((e, t) => (e.id > t.id ? 1 : 0))),
                (r.getRuleset = () => {
                    var t = {},
                        n = 0,
                        r = e.length;
                ...
                (r.verify = function (t, r) {
                    ...
                    (u = t.replace(/\n\r?/g, '$split$').split('$split$')),
                        ...
                        (o = new Reporter(u, r)),
                        (r.errors = 2);
                    for (s in r) Object.hasOwn(r, s) && r[s] && e[s] && e[s].init(f, o);
                    try {
                        f.parse(t);
                    } catch (l) {
                    ...
                    return (
                        ...
                        a.messages.sort((e, t) =>
                            e.rollup && !t.rollup ? 1 : !e.rollup && t.rollup ? -1 : e.line - t.line,
                        ),
                        a
                    );
                }),
        ...
        (Reporter.prototype = {
                            ...
                            for (l = 0; l < s.parts.length; l++) {
                                ...
                                if (o.type === e.SELECTOR_PART_TYPE) {
                                    ...
                                    for (c = 0; c < o.modifiers.length; c++)
                                        (u = o.modifiers[c]),
                                            u.type === 'class' && a++,
                                            a > 1 && t.report("Don't use adjoining classes.", o.line, o.col, this);
                                }
                            }
                        }
                    });
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('property', (e) => {
                        ...
                        r === 'box-sizing' &&
                            t.report("The box-sizing property isn't supported in IE6 and IE7.", e.line, e.col, this);
                    });
                },
            }),
            CSSLint.addRule({
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    ...
                    e.addListener('startrule', () => {
                        ...
                        e.addListener('startkeyframes', (e) => {
                            l = e.prefix || !0;
                        }),
                    ...
                    e.addListener('startrule', s),
                        ...
                        e.addListener('property', (e) => {
                            ...
                            r[o] &&
                                ...
                                t.report("Duplicate property '" + e.property + "' found.", e.line, e.col, this),
                                (r[o] = e.value.text),
                                (i = o);
                        });
                },
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    ...
                    e.addListener('startrule', () => {
                        ...
                        e.addListener('endrule', (e) => {
                            var i = e.selectors;
                            r === 0 && t.report('Rule is empty.', i[0].line, i[0].col, this);
                        });
                },
            }),
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('error', (e) => {
                        t.error(e.message, e.line, e.col, this);
                    });
                },
            }),
            CSSLint.addRule({
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    ...
                    e.addListener('startfontface', () => {
                        ...
                        e.addListener('endstylesheet', () => {
                            r > 5 && t.rollupWarn('Too many @font-face declarations (' + r + ').', this);
                        });
                },
            }),
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('startrule', (r) => {
                        ...
                        for (f = 0; f < i.length; f++) {
                            ...
                            a === 1
                                ? t.report("Don't use IDs in selectors.", s.line, s.col, this)
                                : a > 1 && t.report(a + ' IDs in the selector, really?', s.line, s.col, this);
                        }
                    });
                },
            }),
            CSSLint.addRule({
                ...
                browsers: 'All',
                init: function (e, t) {
                    e.addListener('import', (e) => {
                        t.report('@import prevents parallel downloads, use <link> instead.', e.line, e.col, this);
                    });
                },
            }),
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    var r = 0;
                    e.addListener('property', (e) => {
                        e.important === !0 && (r++, t.report('Use of !important', e.line, e.col, this));
                    }),
                        e.addListener('endstylesheet', () => {
                            t.stat('important', r),
                                r >= 10 &&
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('property', (e) => {
                        e.invalid && t.report(e.invalid.message, e.line, e.col, this);
                    });
                },
            }),
            CSSLint.addRule({
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    ...
                    for (r in a) if (Object.hasOwn(a, r)) for (i = 0, s = a[r].length; i < s; i++) o[a[r][i]] = r;
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('property', (e) => {
                        var r = e.property;
                        r.hack === '*' &&
                            t.report('Property with star prefix found.', e.property.line, e.property.col, this);
                    });
                },
            }),
            CSSLint.addRule({
            ...
            CSSLint.addRule({
                ...
                init: function (e, t) {
                    e.addListener('property', (e) => {
                        var r = e.property;
                        r.hack === '_' &&
                            t.report('Property with underscore prefix found.', e.property.line, e.property.col, this);
                    });
                },
            }),
            CSSLint.addRule({
                ...
                browsers: 'All',
                init: function (e, t) {
                    var r = { h1: 0, h2: 0, h3: 0, h4: 0, h5: 0, h6: 0 };
                    e.addListener('startrule', (e) => {
                        var i = e.selectors,
                            s,
                            o,
                        ...
                        e.addListener('endstylesheet', () => {
                            var e,
                                i = [];
                            for (e in r) Object.hasOwn(r, e) && r[e] > 1 && i.push(r[e] + ' ' + e + 's');
                            i.length && t.rollupWarn('You have ' + i.join(', ') + ' defined in this stylesheet.', this);
                        });
                },
            }),
            CSSLint.addRule({
                    ...
                    e.addListener('startrule', (e) => {
                        ...
                        for (o = 0; o < r.length; o++)
                            (i = r[o]),
                                ...
                                s.elementName === '*' && t.report(this.desc, s.line, s.col, this);
                    });
                },
            }),
            CSSLint.addRule({
                                ...
                                for (f = 0; f < o.modifiers.length; f++)
                                    (u = o.modifiers[f]),
                                        u.type === 'attribute' &&
                                            ...
                                            t.report(this.desc, o.line, o.col, this);
                        }
                    });
                },
            }),
                    ...
                    e.addListener('property', (e) => {
                        ...
                        while (i < s)
                            (r[i].units || r[i].type === 'percentage') &&
                                r[i].value === 0 &&
                                r[i].type !== 'time' &&
                                t.report("Values of 0 shouldn't have units specified.", r[i].line, r[i].col, this),
                                i++;
                    });
                },
            }),
            (() => {
                ...
                CSSLint.addFormatter({
                    ...
                    startFormat: () => '<?xml version="1.0" encoding="utf-8"?><checkstyle>',
                    endFormat: () => '</checkstyle>',
                    readError: (t, n) =>
                        '<file name="' +
                        e(t) +
                    ...
                    formatResults: (t, n) => {
                        var r = t.messages,
                            i = [],
                            s = (e) => (!!e && 'name' in e ? 'net.csslint.' + e.name.replace(/\s/g, '') : '');
                        return (
                            r.length > 0 &&
                                (i.push('<file name="' + n + '">'),
                                CSSLint.Util.forEach(r, (t) => {
                                    t.rollup ||
                                        i.push(
                                            '<error line="' +
                                                t.line +
            ...
            CSSLint.addFormatter({
                ...
                formatResults: (e, t, n) => {
                    var r = e.messages,
                        i = '';
                    n = n || {};
                    var s = (e) => e.charAt(0).toUpperCase() + e.slice(1);
                    return r.length === 0
                        ? n.quiet
                            ? ''
                            : t + ': Lint Free!'
                        : (CSSLint.Util.forEach(r, (e) => {
                              e.rollup
            ...
            CSSLint.addFormatter({
                ...
                startFormat: () => '<?xml version="1.0" encoding="utf-8"?><csslint>',
                endFormat: () => '</csslint>',
                formatResults: (e, t) => {
                    var n = e.messages,
                        r = [],
            ...
            CSSLint.addFormatter({
                ...
                startFormat: () => '<?xml version="1.0" encoding="utf-8"?><testsuites>',
                endFormat: () => '</testsuites>',
                formatResults: (e, t) => {
                    var n = e.messages,
                        r = [],
                        i = { error: 0, failure: 0 },
            ...
            CSSLint.addFormatter({
                ...
                startFormat: () => '<?xml version="1.0" encoding="utf-8"?><lint>',
                endFormat: () => '</lint>',
                formatResults: (e, t) => {
                    var n = e.messages,
                        r = [],
