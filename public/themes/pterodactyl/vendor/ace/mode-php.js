define(
            ...
            var r = e('../lib/oop'),
                ...
                a = function () {
                    ...
                    (this.$rules = {
                        ...
                        heredoc: [
                            {
                                onMatch: (e, t, n) => (n[1] != e ? 'string' : (n.shift(), n.shift(), 'markup.list')),
                                regex: '^\\w+(?=;?$)',
                                next: 'start',
                            },
                            { token: 'string', regex: '.*' },
    ...
    define('ace/mode/matching_brace_outdent', ['require', 'exports', 'module', 'ace/range'], (e, t, n) => {
        var r = e('../range').Range,
            i = () => {};
        (function () {
    ...
    define('ace/mode/php_completions', ['require', 'exports', 'module'], (e, t, n) => {
        function s(e, t) {
    ...
    define('ace/mode/css_completions', ['require', 'exports', 'module'], (e, t, n) => {
        var r = {
                background: { '#$0': 1 },
                ...
                (this.defineCompletions = function () {
                    if (document) {
                        ...
                        for (var t in e) {
                            ...
                            var n = t.replace(/[A-Z]/g, (e) => '-' + e.toLowerCase());
                            Object.hasOwn(r, n) || (r[n] = 1);
                        }
                    }
    ...
    define(
        ...
        (e, t, n) => {
            var r = e('../../lib/oop'),
                ...
                u = function () {
                    this.inherit(s),
                        this.add('colon', 'insertion', (e, t, n, r, i) => {
                            if (i === ':') {
                        ...
                        this.add('colon', 'deletion', (e, t, n, r, i) => {
                        ...
                        this.add('semicolon', 'insertion', (e, t, n, r, i) => {
                            if (i === ';') {
                                var s = n.getCursorPosition(),
    ...
    define(
        ...
        (e, t, n) => {
            ...
            var r = e('../../lib/oop'),
                ...
                o = e('../../lib/lang'),
                a = function () {
                    this.add('string_dquotes', 'insertion', (e, t, n, r, i) => {
                        if (i == '"' || i == "'") {
                            var o = i,
                        ...
                        this.add('autoclosing', 'insertion', function (e, t, n, r, i) {
                            if (i == '>') {
                                ...
                                if (Object.hasOwn(this.voidElements, v.toLowerCase())) return;
        ...
        (e, t, n) => {
            ...
            (function () {
                (this.getFoldWidget = function (e, t, n) {
                    ...
                    return r
                        ? r.closing || (!r.tagName && r.selfClosing)
                            ? t == 'markbeginend'
                                ? 'end'
                                : ''
                            : !r.tagName || r.selfClosing || Object.hasOwn(this.voidElements, r.tagName.toLowerCase())
                              ? ''
                    ...
                    (this._findEndTagInLine = (e, t, n, r) => {
                        var i = e.getTokens(t),
                            s = 0;
                    ...
                    (this._pop = function (e, t) {
                        while (e.length) {
                            ...
                            if (Object.hasOwn(this.optionalEndTags, n.tagName)) {
                                e.pop();
                                continue;
                            }
                            return null;
    ...
    define('ace/mode/html_completions', ['require', 'exports', 'module', 'ace/token_iterator'], (e, t, n) => {
        function f(e, t) {
            return e.type.lastIndexOf(t + '.xml') > -1;
        }
        function l(e, t) {
