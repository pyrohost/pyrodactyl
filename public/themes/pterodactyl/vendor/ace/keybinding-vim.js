define('ace/keyboard/vim', [
    ...
    (v.Pos = function (e, t) {
        ...
        (v.keyMap = {}),
        (v.addClass = v.rmClass = v.e_stop = () => {}),
        (v.keyName = (e) => {
            if (e.key) return e.key;
            var t = a[e.keyCode] || '';
            return (
                t.length == 1 && (t = t.toUpperCase()),
                (t = f.getModifierString(e).replace(/(^|-)\w/g, (e) => e.toUpperCase()) + t),
                t
            );
        }),
                ...
                (this.getSearchCursor = function (e, t, n) {
                    ...
                    return {
                        ...
                        find: (t) => {
                            ...
                            var n = s.find(this.ace.session);
                            return (
                                n &&
                                    n.isEmpty() &&
                                    this.getLine(n.start.row).length == n.start.column &&
                                    ((s.$options.start = n), (n = s.find(this.ace.session))),
                                (a = n),
                                a
                            );
                        },
                        ...
                        to: () => a && g(a.end),
                        replace: (e) => {
                            a && (a.end = this.ace.session.doc.replace(a, e));
                        },
                    };
                }),
    ...
    var b = [
        ...
        E = v.Pos,
        S = () => st;
    v.defineOption('vimMode', !1, (e, t, n) => {
    ...
    var L = { Shift: 'S', Ctrl: 'C', Alt: 'A', Cmd: 'D', Mod: 'A' },
        ...
        q = [].concat(B, j, F, ['-', '"', '.', ':', '/']),
        J = {};
    K('filetype', undefined, 'string', ['ft'], (e, t) => {
    ...
    var nt,
        ...
        st = {
            buildKeyMap: () => {},
            getRegisterController: () => nt.registerController,
            resetVimGlobalState_: rt,
            getVimGlobalState_: () => nt,
    ...
    var ht = {
        ...
        pt = {
            ...
            moveToOtherHighlightedEnd: (e, t, n, r) => {
            ...
            moveByParagraph: (e, t, n) => {
                var r = n.forward ? 1 : -1;
                return ln(e, t, n.repeat, r);
            },
            moveByScroll: (e, t, n, r) => {
            ...
            moveToFirstNonWhiteSpaceCharacter: (e, t) => {
                var n = t;
                return E(n.line, Qt(e.getLine(n.line)));
            },
            moveToMatchedSymbol: (e, t) => {
                var n = t,
                    r = n.line,
                    i = n.ch,
                    s = e.getLine(r),
            ...
            moveToStartOfLine: (e, t) => E(t.line, 0),
            moveToLineOrEdgeOfDocument: (e, t, n) => {
            ...
            textObjectManipulation: (e, t, n, r) => {
                var i = { '(': ')', ')': '(', '{': '}', '}': '{', '[': ']', ']': '[' },
                    s = { "'": !0, '"': !0 },
            ...
            repeatLastCharacterSearch: (e, t, n) => {
        ...
        tn = {
            ...
            section: {
                ...
                isComplete: (e) => e.index === 0 && e.nextCh === e.symb,
            },
            comment: {
                isComplete: (e) => {
    ...
    Bn.prototype = {
        processCommand: function (e, t, n) {
            e.operation(() => {
                (e.curOp.isVimOp = !0), this._processCommand(e, t, n);
            });
        },
    ...
    (S.handleKey = (e, t, n) => e.operation(() => rr(e, t, n), !0)), (t.CodeMirror = v);
    ...
    t.handler = {
        ...
        updateMacCompositionHandlers: (e, t) => {
            var n = function (t) {
                    var n = e.state.cm,
                        r = or(n);
                    if (!r.insertMode) {
    ...
    var ur = {
        getText: (e, t) => (Math.abs(e.selection.lead.row - t) || t + 1 + (t < 9 ? '\u00b7' : '')) + '',
