...
((e) => {
    ...
    define('ace/mode/html/saxparser', ['require', 'exports', 'module'], (e, t, n) => {
                                        ...
                                        if (i === '>') t.setState(n), t._emitCurrentToken();
                                            ...
                                            if (['p', 'P'].indexOf(i) > -1) {
                                                var o = [
                                                    ...
                                                    u = o.every((t) => ((i = e.char()), t.indexOf(i) > -1));
                    ...
                    (e, t, n) => {
                        ...
                        function g() {
                            ...
                            (t.base = {
                                ...
                                (t.initial.processComment = (t) => {
                                    e.insertComment(t, e.document);
                                }),
                                (t.initial.processDoctype = (t, n, r, i) => {
                                    function s(e) {
                                ...
                                (t.beforeHTML.startTagHtml = (t, n, r) => {
                                ...
                                (t.afterAfterBody.processComment = (t) => {
                                    e.insertComment(t, e.document);
                                }),
                                (t.afterAfterBody.processDoctype = (e) => {
                                    t.inBody.processDoctype(e);
                                }),
                                (t.afterAfterBody.startTagHtml = (e, n) => {
                                    t.inBody.startTagHtml(e, n);
                                }),
                                (t.afterAfterBody.startTagOther = (t, n, r) => {
                                    e.parseError('unexpected-start-tag', { name: t }),
                                        e.setInsertionMode('inBody'),
                                        e.insertionMode.processStartTag(t, n, r);
                                }),
                                (t.afterAfterBody.endTagOther = (t) => {
                                    e.parseError('unexpected-end-tag', { name: t }),
                                        e.setInsertionMode('inBody'),
                                        e.insertionMode.processEndTag(t);
                                }),
                                (t.afterAfterBody.processCharacters = (n) => {
                                    if (!p(n.characters))
                                        return (
                                ...
                                (t.afterBody.processComment = (t) => {
                                    e.insertComment(t, e.openElements.rootNode);
                                }),
                                (t.afterBody.processCharacters = (n) => {
                                    if (!p(n.characters))
                                        return (
                                            e.parseError('unexpected-char-after-body'),
                                            e.setInsertionMode('inBody'),
                                ...
                                (t.afterBody.processStartTag = (t, n, r) => {
                                ...
                                (t.afterFrameset.processCharacters = (t) => {
                                ...
                                (t.afterFrameset.startTagNoframes = (e, n) => {
                                    t.inHead.processStartTag(e, n);
                                }),
                                (t.afterFrameset.startTagOther = (t, n) => {
                                    e.parseError('unexpected-start-tag-after-frameset', {
                                        name: t,
                                    });
                                }),
                                (t.afterFrameset.endTagHtml = (t) => {
                                    e.setInsertionMode('afterAfterFrameset');
                                }),
                                (t.afterFrameset.endTagOther = (t) => {
                                ...
                                (t.afterHead.startTagHtml = (e, n) => {
                                    t.inBody.processStartTag(e, n);
                                }),
                                (t.afterHead.startTagBody = (t, n) => {
                                    (e.framesetOk = !1), e.insertBodyElement(n), e.setInsertionMode('inBody');
                                }),
                                (t.afterHead.startTagFrameset = (t, n) => {
                                    e.insertElement(t, n), e.setInsertionMode('inFrameset');
                                }),
                                (t.afterHead.startTagFromHead = (n, r, i) => {
                                ...
                                (t.afterHead.startTagHead = (t, n, r) => {
                                    e.parseError('unexpected-start-tag', { name: t });
                                }),
                                ...
                                (t.afterHead.endTagOther = (t) => {
                                    e.parseError('unexpected-end-tag', { name: t });
                                }),
                                (t.afterHead.anythingElse = () => {
                                ...
                                (t.inBody.processCharacters = (t) => {
                                    ...
                                    var n = t.takeRemaining();
                                    n = n.replace(/\u0000/g, (t, n) => (e.parseError('invalid-codepoint'), ''));
                                    if (!n) return;
                                    e.insertText(n), e.framesetOk && !d(n) && (e.framesetOk = !1);
                                }),
                                (t.inBody.startTagHtml = (t, n) => {
                                    e.parseError('non-html-root'), e.addAttributesToElement(e.openElements.rootNode, n);
                                }),
                                (t.inBody.startTagProcessInHead = (e, n) => {
                                    t.inHead.processStartTag(e, n);
                                }),
                                (t.inBody.startTagBody = (t, n) => {
                                ...
                                (t.inBody.startTagFormatting = (t, n) => {
                                ...
                                (t.inBody.startTagAppletMarqueeObject = (t, n) => {
                                    e.reconstructActiveFormattingElements(),
                                        e.insertElement(t, n),
                                        e.activeFormattingElements.push(l),
                                        (e.framesetOk = !1);
                                }),
                                (t.inBody.endTagAppletMarqueeObject = (t) => {
                                ...
                                (t.inBody.startTagVoidFormatting = (t, n) => {
                                    e.reconstructActiveFormattingElements(),
                                        e.insertSelfClosingElement(t, n),
                                        (e.framesetOk = !1);
                                }),
                                (t.inBody.startTagParamSourceTrack = (t, n) => {
                                    e.insertSelfClosingElement(t, n);
                                }),
                                ...
                                (t.inBody.startTagRawText = (t, n) => {
                                    e.processGenericRawTextStartTag(t, n);
                                }),
                                (t.inBody.startTagSelect = (t, n) => {
                                ...
                                (t.inBody.startTagMisplaced = (t, n) => {
                                    e.parseError('unexpected-start-tag-ignored', { name: t });
                                }),
                                (t.inBody.endTagMisplaced = (t) => {
                                    e.parseError('unexpected-end-tag', { name: t });
                                }),
                                (t.inBody.endTagBr = (t) => {
                                    ...
                                    for (var r = e.openElements.length - 1; r > 0; r--) {
                                        ...
                                        if (n.localName == t) {
                                            e.generateImpliedEndTags(t),
                                                e.currentStackItem().localName != t &&
                                                    e.parseError('unexpected-end-tag', { name: t }),
                                                e.openElements.remove_openElements_until((e) => e === n);
                                            break;
                                        }
                                        if (n.isSpecial()) {
                                            e.parseError('unexpected-end-tag', { name: t });
                                ...
                                (t.inBody.endTagHeading = (t) => {
                                    ...
                                    e.generateImpliedEndTags(),
                                        e.currentStackItem().localName != t &&
                                            e.parseError('end-tag-too-early', { name: t }),
                                        e.openElements.remove_openElements_until((e) => e.isNumberedHeader());
                                }),
                                ...
                                (t.inCaption.endTagIgnore = (t) => {
                                    e.parseError('unexpected-end-tag', { name: t });
                                }),
                                (t.inCaption.endTagOther = (e) => {
                                ...
                                (t.inCell.startTagOther = (e, n, r) => {
                                    t.inBody.processStartTag(e, n, r);
                                }),
                                (t.inCell.endTagTableCell = (t) => {
                                ...
                                (t.inColumnGroup.ignoreEndTagColgroup = () => e.currentStackItem().localName == 'html'),
                                ...
                                (t.inColumnGroup.startTagCol = (t, n) => {
                                    e.insertSelfClosingElement(t, n);
                                }),
                                ...
                                (t.inForeignContent.processStartTag = (t, n, r) => {
                                    if (
                                        [
                                            'b',
                                            'big',
                                        ...
                                        (t == 'font' &&
                                            n.some((e) => ['color', 'face', 'size'].indexOf(e.nodeName) >= 0))
                                    ) {
                                ...
                                (t.inForeignContent.processEndTag = (t) => {
                                ...
                                (t.inForeignContent.processCharacters = (t) => {
                                    var n = t.takeRemaining();
                                    (n = n.replace(/\u0000/g, (t, n) => (e.parseError('invalid-codepoint'), '\ufffd'))),
                                ...
                                (t.inHeadNoscript.processComment = (e) => {
                                    t.inHead.processComment(e);
                                }),
                                (t.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle = (e, n) => {
                                    t.inHead.processStartTag(e, n);
                                }),
                                (t.inHeadNoscript.startTagHeadNoscript = (t, n) => {
                                ...
                                (t.inHeadNoscript.endTagNoscript = (t, n) => {
                                    e.popElement(), e.setInsertionMode('inHead');
                                }),
                                (t.inHeadNoscript.endTagOther = (t, n) => {
                                    e.parseError('unexpected-end-tag-in-frameset', { name: t });
                                }),
                                ...
                                (t.inFrameset.processCharacters = (t) => {
                                    e.parseError('unexpected-char-in-frameset');
                                }),
                                (t.inFrameset.startTagFrameset = (t, n) => {
                                    e.insertElement(t, n);
                                }),
                                (t.inFrameset.startTagFrame = (t, n) => {
                                    e.insertSelfClosingElement(t, n);
                                }),
                                (t.inFrameset.startTagNoframes = (e, n) => {
                                    t.inBody.processStartTag(e, n);
                                }),
                                (t.inFrameset.startTagOther = (t, n) => {
                                    e.parseError('unexpected-start-tag-in-frameset', {
                                        name: t,
                                    });
                                }),
                                (t.inFrameset.endTagFrameset = (t, n) => {
                                ...
                                (t.inFrameset.endTagNoframes = (e) => {
                                    t.inBody.processEndTag(e);
                                }),
                                (t.inFrameset.endTagOther = (t) => {
                                    e.parseError('unexpected-end-tag-in-frameset', { name: t });
                                }),
                                ...
                                (t.inTable.startTagRowGroup = (t, n) => {
                                    e.openElements.popUntilTableScopeMarker(),
                                        e.insertElement(t, n),
                                ...
                                (t.inTable.startTagStyleScript = (e, n) => {
                                    t.inHead.processStartTag(e, n);
                                }),
                                ...
                                (t.inTable.endTagIgnore = (t) => {
                                    e.parseError('unexpected-end-tag', { name: t });
                                }),
                                (t.inTable.endTagOther = (n) => {
                                ...
                                (t.inTableText.processCharacters = (t) => {
                                    var n = t.takeRemaining();
                                    n = n.replace(/\u0000/g, (t, n) => (e.parseError('invalid-codepoint'), ''));
                                    if (!n) return;
                                ...
                                (t.inTableBody.processCharacters = (e) => {
                                    t.inTable.processCharacters(e);
                                }),
                                (t.inTableBody.startTagTr = (t, n) => {
                                ...
                                (t.inTableBody.startTagOther = (e, n) => {
                                    t.inTable.processStartTag(e, n);
                                }),
                                (t.inTableBody.endTagTableRowGroup = (t) => {
                                    e.openElements.inTableScope(t)
                                        ? (e.openElements.popUntilTableBodyScopeMarker(),
                                          e.popElement(),
                                          e.setInsertionMode('inTable'))
                                ...
                                (t.inTableBody.endTagIgnore = (t) => {
                                    e.parseError('unexpected-end-tag-in-table-body', {
                                        name: t,
                                    });
                                }),
                                (t.inTableBody.endTagOther = (e) => {
                                ...
                                (t.inSelect.startTagOther = (t, n) => {
                                    e.parseError('unexpected-start-tag-in-select', { name: t });
                                }),
                                (t.inSelect.endTagOther = (t) => {
                                    e.parseError('unexpected-end-tag-in-select', { name: t });
                                }),
                                ...
                                (t.inSelectInTable.processCharacters = (e) => {
                                ...
                                (t.inSelectInTable.startTagOther = (e, n, r) => {
                                ...
                                (t.inSelectInTable.endTagOther = (e) => {
                                ...
                                (t.inRow.processCharacters = (e) => {
                                    t.inTable.processCharacters(e);
                                }),
                                (t.inRow.startTagTableCell = (t, n) => {
                                ...
                                (t.inRow.endTagIgnore = (t) => {
                                    e.parseError('unexpected-end-tag-in-table-row', {
                                        name: t,
                                    });
                                }),
                                (t.inRow.endTagOther = (e) => {
                                    t.inTable.processEndTag(e);
                                }),
                                (t.inRow.ignoreEndTagTr = () => !e.openElements.inTableScope('tr')),
                                ...
                                (t.afterAfterFrameset.processEOF = () => {}),
                                (t.afterAfterFrameset.processComment = (t) => {
                                    e.insertComment(t, e.document);
                                }),
                                (t.afterAfterFrameset.processCharacters = (t) => {
                                    var n = t.takeRemaining(),
                                        r = '';
                                    for (var i = 0; i < n.length; i++) {
                                        var s = n[i];
                                ...
                                (t.afterAfterFrameset.startTagNoFrames = (e, n) => {
                                    t.inHead.processStartTag(e, n);
                                }),
                                (t.afterAfterFrameset.startTagOther = (t, n, r) => {
                                    e.parseError('expected-eof-but-got-start-tag', { name: t });
                                }),
                                (t.afterAfterFrameset.processEndTag = (t, n) => {
                        ...
                        (m.prototype.skipAtMostOneLeadingNewline = function () {
                            ...
                            (g.prototype.createElement = (e, t, n) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.attachNode = (e, t) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.attachNodeToFosterParent = (e, t, n) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.detachFromParent = (e) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.addAttributesToElement = (e, t) => {
                                throw new Error('Not implemented');
                            }),
                            ...
                            (g.prototype.insertComment = (e, t) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.insertDoctype = (e, t, n) => {
                                throw new Error('Not implemented');
                            }),
                            (g.prototype.insertText = (e) => {
                                throw new Error('Not implemented');
                            }),
                            ...
                            (g.prototype.reparentChildren = (e, t) => {
                                throw new Error('Not implemented');
                            }),
                            ...
                            (g.prototype.adjustMathMLAttributes = (e) => (
                                e.forEach((e) => {
                            ...
                            (g.prototype.adjustSVGTagNameCase = (e) => s.SVGTagMap[e] || e),
                            (g.prototype.adjustSVGAttributes = (e) => (
                                e.forEach((e) => {
                            ...
                            (g.prototype.adjustForeignAttributes = (e) => {
                                for (var t = 0; t < e.length; t++) {
                                    var n = e[t],
                ...
                10: [
                    (e, t, n) => {
                        ...
                        r.inherits(s, i),
                            ...
                            (s.prototype.attachNode = (e, t) => {
                                t.appendChild(e);
                            }),
                            (s.prototype.attachNodeToFosterParent = (e, t, n) => {
                                var r = t.parentNode;
                                r ? r.insertBetween(e, t.previousSibling, t) : n.appendChild(e);
                            }),
                            (s.prototype.detachFromParent = (e) => {
                                e.detach();
                            }),
                            (s.prototype.reparentChildren = (e, t) => {
                            ...
                            (s.prototype.addAttributesToElement = (e, t) => {
                        ...
                        (a.prototype.visit = (e) => {
                            ...
                            (b.prototype.getNodeType = () => u.PROCESSING_INSTRUCTION),
                ...
                11: [
                    (e, t, n) => {
                        ...
                        (r.prototype.parse = function (e) {
                            ...
                            (i.prototype.comment = () => {}),
                            (i.prototype.endCDATA = () => {}),
                            (i.prototype.endDTD = () => {}),
                            (i.prototype.endEntity = () => {}),
                            (i.prototype.startCDATA = () => {}),
                            (i.prototype.startDTD = () => {}),
                            (i.prototype.startEntity = () => {}),
                            (n.TreeParser = r);
                    },
                    {},
                ],
                        ...
                        ((t, r) => {
                            ...
                            function c(e, t, r) {
                                ...
                                if (o.length !== 0 || (!!y && t.length != 0)) {
                                    ...
                                    var E;
                                    return (
                                        y ? (E = d(e, t, r, u, o)) : (E = o.map((n) => v(e, t, r, u, n, y))),
                                        e.seen.pop(),
                                        m(E, f, b)
                                    );
                                }
                ...
                18: [
                    (e, t, n) => {
                        ...
                        (r.nextTick = (() => {
                            ...
                            if (e) return (e) => window.setImmediate(e);
                            if (t) {
                                var n = [];
                                return (
