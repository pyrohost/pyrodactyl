        ...
        r.inherits(a, s),
            function () {
                (this.enter = function (e, t) {
                    ...
                    (this.originalToOccurPosition = (e, t) => {
                    ...
                    (this.occurToOriginalPosition = (e, t) => {
                        var n = e.$occurMatchingLines;
                        return !n || !n[t.row] ? t : { row: n[t.row].row, column: t.column };
                    }),
                    (this.matchingLines = (e, t) => {
                        t = r.mixin({}, t);
                        if (!e || !t.needle) return [];
                        var n = new s();
                        return (
                            n.set(t),
                            n.findAll(e).reduce((t, n) => {
                                var r = n.start.row,
                                    i = t[t.length - 1];
            ...
            (t.iSearchStartCommands = [
                {
                    ...
                    exec: (e, t) => {
                        r.loadModule(['core', 'ace/incremental_search'], (n) => {
                ...
                (t.iSearchCommands = [
                    ...
                    },
                    {
                        ...
                        exec: (e) => {
                            var t = e.$editor,
                                n = t.selection.getRangeOfMovements((e) => {
                    ...
                    },
                    {
                        ...
                        exec: (e) => {
                            var t = e.$editor,
                                ...
                                r = n && n.cache ? n.cache.reduce((e, t) => e.concat(t ? t : []), []) : [];
                ...
                function () {
                    (this.attach = function (e) {
                        ...
                        s.call(this, t.iSearchCommands, e.commands.platform),
                            (this.$commandExecHandler = e.commands.addEventListener('exec', (t) => {
                ...
                function () {
                    (this.activate = function (e, t) {
                        ...
                        (this.addString = function (e) {
                            return this.highlightAndFindWithNeedle(!1, (t) => {
                                if (!l(t)) return t + e;
                                var n = c(t);
        ...
        (e, t, n) => {
            ...
            var l = (e) => {
                    e.oldSession && ((e.oldSession.$selectLongWords = a), (e.oldSession.$useEmacsStyleLineStart = f)),
                        ...
                        (f = e.session.$useEmacsStyleLineStart),
                        (e.session.$useEmacsStyleLineStart = !0),
                        Object.hasOwn(e.session, '$emacsMark') || (e.session.$emacsMark = null),
                        Object.hasOwn(e.session, '$emacsMarkRing') || (e.session.$emacsMarkRing = []);
                },
                c = (e) => {
