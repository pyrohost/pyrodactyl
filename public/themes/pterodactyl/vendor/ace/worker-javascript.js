...
((e) => {
    ...
    define('ace/mode/javascript/jshint', ['require', 'exports', 'module'], (e, t, n) => {
                    ...
                    function (e, t, n) {
                        (function (e) {
                            (function () {
                                ...
                                function Jt(e) {
                                    ...
                                    if (n == 1) {
                                        var i = t[0],
                                            s = e[i];
                                        if (kn(s))
                                            return (e) => (e == null ? !1 : e[i] === s && (s !== r || i in On(e)));
                                    }
                                    var o = Array(n),
                                        u = Array(n);
                                    while (n--) (s = e[t[n]]), (o[n] = s), (u[n] = kn(s));
                                    return (e) => e != null && $t(On(e), t, o, u);
                                }
                                function Kt(e, t) {
                                    var n = Xn(e),
                                        i = Nn(e) && kn(t),
                                ...
                                function Yt(e) {
                                    return (t) => (t == null ? r : t[e]);
                                }
                                function Zt(e) {
                                    var t = e + '';
                                    return (e = Mn(e)), (n) => Wt(n, e, t);
                                }
                                function en(e, t, n) {
                                    var i = -1,
                                        s = e.length;
                                ...
                                function tn(e, t) {
                                    var n;
                                    return It(e, (e, r, i) => ((n = t(e, r, i)), !n)), !!n;
                                }
                                function nn(e, t) {
                                    var n = -1,
                                        r = t.length,
                                ...
                                function on(e, t, n) {
                                    ...
                                    switch (n) {
                                        ...
                                        case 4:
                                            return (n, r, i, s) => e.call(t, n, r, i, s);
                                        case 5:
                                            return (n, r, i, s, o) => e.call(t, n, r, i, s, o);
                                    }
                                    return function () {
                                ...
                                function cn(e) {
                                    return (t, n, r) => (!t || !t.length ? -1 : ((n = mn(n, r, 3)), $(t, n, e)));
                                }
                                function hn(e, t) {
                                    return (n, i, s) =>
                                        typeof i == 'function' && s === r && Xn(n) ? e(n, i) : t(n, on(i, s, 3));
                                }
                                ...
                                function qn(e, t, n) {
                                    var r = Xn(e) ? Ot : qt;
                                    return (t = mn(t, n, 3)), r(e, (e, n, r) => !t(e, n, r));
                                }
                                function Rn(e, t, n) {
                                    var i = Xn(e) ? Dt : tn;
                                    n && Tn(e, t, n) && (t = null);
                                ...
                                var Ht = vt || ((e, t) => (t == null ? e : Bt(t, bn(t), Bt(t, rr(t), e)))),
                                    It = fn(zt),
                                    Rt = ln();
                                ot ||
                                    (un =
                                ...
                                var yn = Yt('length'),
                                    ...
                                    jn = Un(Bn),
                                    Fn = hn(At, It),
                                    Xn = mt || ((e) => Y(e) && Cn(e.length) && rt.call(e) == u),
                                    $n = K(/x/) || (pt && !K(pt)) ? (e) => rt.call(e) == c : K,
                                    Gn = ft
                                        ? (e) => {
                        ...
                        var r = e('../lodash'),
                            ...
                            p = (() => {
                                ...
                                function j() {
                                    ...
                                    p.errors = r.reject(p.errors, (t) => e[t.line]);
                                }
                                        ...
                                        e.id === '.'
                                            ...
                                            : e.id === '{' || e.id === '['
                                              ? (r && f.tokens.curr.left.destructAssign
                                                    ? f.tokens.curr.left.destructAssign.forEach((e) => {
                                ...
                                function Zt(e, t) {
                                    var n = t.first;
                                    if (!n) return;
                                    r.zip(e, Array.isArray(n) ? n : [n]).forEach((e) => {
                                        var t = e[0],
                                            n = e[1];
                                        t && n
                                            ? (t.first = n)
                                ...
                                var Ht = 40;
                                ht('||', (e, t) => ($t(), (t.left = e), (t.right = Q(Ht)), t), Ht),
                                    ht('&&', 'and', 50),
                                    St('|', 'bitor', 70),
                                    St('^', 'bitxor', 80),
                                    St('&', 'bitand', 90),
                                ...
                                var an = () => {
                                    ...
                                    yn = (t, i, o) => {
                                        ...
                                        (e = {
                                            ...
                                            getOption: (e) => f.option[e] || null,
                                            getCache: (e) => f.cache[e],
                                            setCache: (e, t) => {
                                                f.cache[e] = t;
                                            },
                                            warn: (e, t) => {
                                            ...
                                            i &&
                                                ...
                                                i.ignoreDelimiters.forEach((e) => {
                                                    if (!e.start || !e.end) return;
                                                    (d = gn(e.start) + '[\\s\\S]*?' + gn(e.end)),
                                                        (A = new RegExp(d, 'ig')),
                                                        (t = t.replace(A, (e) => e.replace(/./g, ' ')));
                                                })),
                                            (b = new u(t)),
                                            b.on('warning', (e) => {
                        ...
                        (p.prototype = {
                            ...
                            nextLine: function () {
                                ...
                                var t = this.input.trim(),
                                    n = function () {
                                        return r.some(arguments, (e) => t.indexOf(e) === 0);
                                    },
                                    i = function () {
                                        return r.some(arguments, (e) => t.indexOf(e, t.length - e.length) !== -1);
                                    };
                                        ...
                                        case l.NumericLiteral:
                                            return (
                                                ...
                                                this.triggerAsync(
                                                    ...
                                                    e,
                                                    () => o.isStrict() && t.base === 8 && t.isLegacy,
                                                ),
                                                this.trigger('Number', {
                                                    line: this.line,
                                                    char: this.char,
