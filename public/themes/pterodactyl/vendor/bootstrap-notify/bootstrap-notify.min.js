...
!((t) => {
    ...
    (String.format = function () {
        ...
        t.extend(e.prototype, {
            ...
            bind: function () {
                if (
                    ...
                    var s = setInterval(() => {
                        var t = parseInt(this.$ele.data('notify-delay')) - this.settings.timer;
                        if (
                            ('false' === this.$ele.data('data-hover') && 'pause' == this.settings.mouse_over) ||
                            'pause' != this.settings.mouse_over
                        ) {
                            var i = ((this.settings.delay - t) / this.settings.delay) * 100;
                            this.$ele.data('notify-delay', t),
                                this.$ele
                                    .find('[data-notify="progressbar"] > div')
                                    .attr('aria-valuenow', i)
                                    .css('width', i + '%');
                        }
                        t <= -this.settings.timer && (clearInterval(s), this.close());
                    }, this.settings.timer);
                }
            },
            close: function () {
        ...
        (t.notifyDefaults = (e) => (s = t.extend(!0, {}, s, e))),
        (t.notifyClose = (e) => {
