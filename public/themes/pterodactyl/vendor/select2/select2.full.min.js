	...
	var b = (() => {
			...
			return (
						...
						!((b) => {
							...
							(o = (a, b) => {
								...
								(p = {
									...
									module: (a) => ({ id: a, uri: "", exports: q[a], config: l(a) }),
								}),
								(m = (a, c, d, f) => {
									var h,
										k,
				...
				b.define(
					...
					(a, b, c) => {
						...
						return (
							...
							(d.prototype._attachCloseHandler = (b) => {
				...
				b.define("select2/selection/placeholder", ["../utils"], (a) => {
					...
					return (
						(b.prototype.normalizePlaceholder = (a, b) => ("string" == typeof b && (b = { id: "", text: b }), b)),
						...
						return (
							...
							(d.prototype.bind = function (a, b, d) {
								a.call(this, b, d),
									...
									this.$selection.on(
										...
										(a) => {
											...
											var b = a.which;
											if (b === c.BACKSPACE && "" === this.$search.val()) {
												var d = this.$searchContainer.prev(
													".select2-selection__choice",
												);
												if (d.length > 0) {
													var f = d.data("data");
													this.searchRemoveChoice(f), a.preventDefault();
												}
											}
										},
									);
								...
								this.$selection.on(
									...
									".select2-search--inline",
									(a) => g
											? void this.$selection.off("input.search input.searchcheck")
											: void this.$selection.off("keyup.search"),
								),
									this.$selection.on(
										...
										(a) => {
											if (g && "input" === a.type)
												return void this.$selection.off(
					...
					return (
						(a.prototype.query = function (a, b, c) {
							this.current((e) => {
								...
								return this.maximumSelectionLength > 0 &&
						...
						return (
							...
							(c.prototype.bind = function (b, c, d) {
								b.call(this, c, d),
									...
									c.on("close", () => {
										this.$search.attr("tabindex", -1), this.$search.val("");
									}),
									c.on("focus", () => {
				...
				b.define("select2/dropdown/hidePlaceholder", [], () => {
					...
					return (
						...
						(a.prototype.normalizePlaceholder = (a, b) => ("string" == typeof b && (b = { id: "", text: b }), b)),
				...
				b.define("select2/compat/inputData", ["jquery"], (a) => {
					...
					return (
						...
						(b.prototype.unselect = function (a, b) {
							(b.selected = !1),
								this.current((a) => {
									...
									this.$element.val(d.join(this._valueSeparator)),
										this.$element.trigger("change");
								});
						}),
						(b.prototype.query = function (a, b, c) {
						...
						(b.prototype.addOptions = function (b, c) {
							var d = a.map(c, (b) => a.data(b[0], "data"));
