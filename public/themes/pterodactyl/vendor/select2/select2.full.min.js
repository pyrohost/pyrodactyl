/*! Select2 4.0.3 | https://github.com/select2/select2/blob/master/LICENSE.md */ !((a) => {
                        ...
                        (c.prototype.setClasses = function () {
                            this.data.current((c) => {
                                var d = a.map(c, (a) => a.id.toString()),
                                    e = this.$results.find('.select2-results__option[aria-selected]');
                                e.each(function () {
                                    var b = a(this),
                                        c = a.data(this, 'data'),
                                        e = '' + c.id;
                ...
                b.define('select2/selection/base', ['jquery', '../utils', '../keys'], (a, b, c) => {
                    ...
                    return (
                        ...
                        (d.prototype.bind = function (a, b) {
                            var e = (a.id + '-container', a.id + '-results');
                            (this.container = a),
                    ...
                    return (
                        (a.prototype.query = function (a, b, c) {
                            this.current((e) => {
                                ...
                                return this.maximumSelectionLength > 0 && f >= this.maximumSelectionLength
                                    ? void this.trigger('results:message', {
                ...
                b.define('select2/core', ['jquery', './options', './utils', './keys'], (a, b, c, d) => {
                    ...
                    return (
                        ...
                        (e.prototype.val = function (b) {
                            ...
                            var c = b[0];
                            a.isArray(c) && (c = a.map(c, (a) => a.toString())), this.$element.val(c).trigger('change');
                        }),
