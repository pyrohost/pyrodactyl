!((t, e) => {
    ...
    ((t) => {
        ...
        (t, e, n) => {
            ((e) => {
                function r(t) {
                    ...
                    for (var c in t) if (Object.hasOwn(t, c) && r(t[c])) return !0;
                    return !1;
                }
                var o = n(10),
        ...
        (t, e) => {
            var n = {}.toString;
            t.exports = Array.isArray || ((t) => '[object Array]' == n.call(t));
        },
        (t, e, n) => {
            ((t) => {
                function r(t, e) {
                ...
                (e.deconstructPacket = (t) => {
                    ...
                    (e.reconstructPacket = (t, e) => ((t.data = o(t.data, e)), (t.attachments = void 0), t)),
                    (e.removeBlobs = (t, e) => {
                        function n(t, a, u) {
                            if (!t) return t;
            ...
            (t.exports = r),
                        ...
                        if (!1 !== this._timeout) {
                            ...
                            var c = setTimeout(() => {
                                h('connect attempt timed out after %d', a),
                                    ...
                                    this.emitAll('connect_timeout', a);
                            }, a);
                            this.subs.push({
                                destroy: () => {
                                    clearTimeout(c);
                ...
                (r.prototype.packet = function (t) {
                    ...
                    t.query && 0 === t.type && (t.nsp += '?' + t.query),
                        this.encoding
                            ? this.packetBuffer.push(t)
                            : ((this.encoding = !0),
                              this.encoder.encode(t, (n) => {
                                  for (var r = 0; r < n.length; r++) this.engine.write(n[r], t.options);
                                  (this.encoding = !1), this.processPacketQueue();
                              }));
                }),
                                    ...
                                    this.open((e) => {
                                        e
                                            ? (h('reconnect attempt error'),
                                              (this.reconnecting = !1),
                                              this.reconnect(),
                                              this.emitAll('reconnect_error', e.data))
                                            : (h('reconnect success'), this.onreconnect());
                                    }));
                        }, e);
                        this.subs.push({
                            destroy: () => {
                ...
                (t.exports = r),
                    ...
                    (r.prototype.onHeartbeat = function (t) {
                        ...
                        this.pingTimeoutTimer = setTimeout(
                            () => {
                                'closed' !== this.readyState && this.onClose('ping timeout');
                            },
                            t || this.pingInterval + this.pingTimeout,
                        );
                    }),
                    (r.prototype.setPing = function () {
                        clearTimeout(this.pingIntervalTimer),
                            (this.pingIntervalTimer = setTimeout(() => {
                                a('writing ping packet - expecting pong within %sms', this.pingTimeout),
                                    this.ping(),
        ...
        (t, e, n) => {
            ((e) => {
                ...
                function s() {
                    for (var t in i.requests) Object.hasOwn(i.requests, t) && i.requests[t].abort();
                }
                var a = n(18),
                    c = n(21),
                    p = n(8),
                            ...
                            try {
                                if (this.extraHeaders) {
                                    ...
                                    for (var o in this.extraHeaders)
                                        Object.hasOwn(this.extraHeaders, o) &&
        ...
        (t, e, n) => {
            ...
            a(r, o),
                ...
                (r.prototype.onData = function (t) {
                    ...
                    var n = (t, n, r) => (
                        'opening' === this.readyState && this.onOpen(),
                        'close' === t.type ? (this.onClose(), !1) : void this.onPacket(t)
                    );
                ...
                (e.encodePacket = (e, n, i, a) => {
                    ...
                    (e.encodePayload = (t, n, r) => {
                        ...
                        return n && s
                            ...
                            : t.length
                              ? void c(t, i, (t, e) => r(e.join('')))
                              : r('0:');
                    }),
                    (e.decodePayload = (t, n, r) => {
        ...
        (t, e, n) => {
            ...
            (function (t, o) {
                !((i) => {
                    ...
                    (r = (() => k).call(e, n, e, t)), !(void 0 !== r && (t.exports = r));
                })(this);
            }).call(
                e,
                n(28)(t),
        ...
        (t, e) => {
            t.exports = (t) => (
                t.webpackPolyfill ||
                    ((t.deprecate = () => {}), (t.paths = []), (t.children = []), (t.webpackPolyfill = 1)),
                t
            );
        },
        (t, e) => {
        ...
        (t, e) => {
            ((e) => {
                ...
                t.exports = (() => (s ? (a ? e.Blob : o) : c ? r : void 0))();
            }).call(
                e,
                (function () {
                    return this;
                    ...
                    a.push((t) => {
                        ...
                        e.document &&
                            ...
                            e.addEventListener(
                                'beforeunload',
                                () => {
                                    this.script && (this.script.onerror = r);
                                },
                                !1,
                            );
                }
                    ...
                    (o.prototype.doWrite = function (t, e) {
                        ...
                        this.iframe.attachEvent
                            ? (this.iframe.onreadystatechange = () => {
                                  'complete' === this.iframe.readyState && n();
                              })
                ...
                l || 'undefined' != typeof window || (l = o),
                    ...
                    (r.prototype.write = function (t) {
                        ...
                        for (var o = t.length, i = 0, a = o; i < a; i++)
                            !((t) => {
                                s.encodePacket(t, this.supportsBinary, (i) => {
                                    if (!this.usingBrowserWebSocket) {
                                        var s = {};
                                        if ((t.options && (s.compress = t.options.compress), this.perMessageDeflate)) {
                                            var a = 'string' == typeof i ? e.Buffer.byteLength(i) : i.length;
                                            a < this.perMessageDeflate.threshold && (s.compress = !1);
                                        }
                                    }
                                    try {
                                        this.usingBrowserWebSocket ? this.ws.send(i) : this.ws.send(i, s);
                                    } catch (c) {
        ...
        (t, e, n) => {
            ...
            s(r.prototype),
                ...
                (r.prototype.emit = function (t) {
                    if (Object.hasOwn(f, t)) return l.apply(this, arguments), this;
                    var e = a(arguments),
