!((n, t) => {
    ...
    function yn(n, t, e) {
        ...
        function u(n) {
            return a((t) => {
                (i -= 1),
                    Q(n, (n) => {
                        Q(o, (t, e) => (t === n ? (o.splice(e, 1), !1) : void 0)),
        ...
        var i = 0,
            ...
            c = {
                ...
                length: () => c._tasks.length,
                running: () => i,
                workersList: () => o,
                idle: () => c._tasks.length + i === 0,
                pause: () => {
                    c.paused = !0;
                },
                resume: () => {
    ...
    function Yn(n, t, e) {
        ...
        Wt(
            n,
            (n, e) => {
                t(n, (t, r) => (t ? e(t) : void e(null, { value: n, criteria: r })));
            },
            (n, t) => (n ? e(n) : void e(null, X(t.sort(r), p('value')))),
        );
    }
    function Zn(n, t, e) {
        function r() {
    ...
    function ut(n, t, e) {
        ...
        var r = a((u, i) => (u ? e(u) : n() ? t(r) : void e.apply(null, [null].concat(i))));
        t(r);
    }
    function it(n, t, e) {
        ut(
    ...
    function ot(n, t) {
        function e(u) {
            ...
            var i = $(a((n, r) => (n ? t.apply(null, [n].concat(r)) : void e(r))));
            u.push(i);
            var o = n[r++];
            o.apply(null, u);
        }
    ...
    var ct,
        ...
        Jt = M(Ht, 1),
        Kt = s(Jt),
        Xt = a((n, t) => a((e) => n.apply(null, t.concat(e)))),
        Yt = W(),
            ...
            a(function (t) {
                ...
                'function' == typeof r ? t.pop() : (r = y),
                    dn(
                        ...
                        (n, t) => {
                            r.apply(this, [n].concat(t));
                        },
                    );
            }),
        ),
        Me = a((n) => Be.apply(null, n.reverse())),
        Ve = P(gn),
        qe = bn(gn),
        Ce = a((n) => {
            var t = [null].concat(n);
