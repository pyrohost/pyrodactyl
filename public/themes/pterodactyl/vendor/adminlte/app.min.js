	...
	((a) => {
		...
		(h.prototype.toggle = function () {
			...
			(h.prototype._setUpListeners = function () {
				a(this.element).on("click", this.options.collapseTrigger, (a) => {
					a && a.preventDefault(), this.toggle();
				}),
					a(this.element).on("click", this.options.removeTrigger, (a) => {
						a && a.preventDefault(), this.remove();
					});
			});
