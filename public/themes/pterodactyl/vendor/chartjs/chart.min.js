					...
					(o.prototype = {
						...
						luminosity: function () {
							for (var t = this.values.rgb, e = [], a = 0; a < t.length; a++) {
								var i = t[a] / 255;
								e[a] = 0.03928 >= i ? i / 12.92 : ((i + 0.055) / 1.055) ** 2.4;
							}
						...
						(t.defaults.bar = {
							...
							(t.controllers.horizontalBar = t.controllers.bar.extend({
								...
								calculateBarHeight: function (t) {
									var a = this.getScaleForId(this.getMeta().yAxisID);
						...
						(t.defaults.bubble = {
							...
							(t.controllers.bubble = t.DatasetController.extend({
								...
								removeHoverStyle: function (e) {
									...
									var i =
											this.chart.data.datasets[e._datasetIndex].data[e._index],
										n = e.custom || {},
										o = e._model;
								...
								update: function (t) {
									...
									(i.outerRadius = Math.max((s - l.borderWidth / 2) / 2, 0)),
										...
										(i.radiusLength =
											...
											i.getVisibleDatasetCount()),
										(this.outerRadius =
											i.outerRadius - i.radiusLength * this.index),
										(this.innerRadius = this.outerRadius - i.radiusLength),
						...
						(t.types = {}),
							...
							e.extend(t.Controller.prototype, {
								...
								buildScales: function () {
									...
									i.scales &&
										(o = o.concat(
											(i.scales.xAxes || []).map((t) => ({
												options: t,
												dtype: "category",
											})),
											(i.scales.yAxes || []).map((t) => ({
												options: t,
												dtype: "linear",
											})),
										)),
											...
											(e, o) => {
												...
												r.type || (r.type = e.type || this.config.type),
													...
													r.controller
														...
														: ((r.controller = new t.controllers[r.type](
																this,
																o,
															)),
															n.push(r.controller));
									...
									return (
										e.each(this.data.datasets, (t, o) => {
											if (this.isDatasetVisible(o)) {
												var r = this.getDatasetMeta(o);
												e.each(r.data, (t) =>
													t.inRange(i.x, i.y) ? (n.push(t), n) : void 0,
												);
											}
										}),
										n.slice(0, 1)
						...
						(t.DatasetController = function (t, e) {
							...
							e.extend(t.DatasetController.prototype, {
								...
								addElementAndReset: function (t) {
									var a = this.createMetaData(t);
									this.getMeta().data.splice(t, 0, a),
										this.updateElement(a, t, !0);
								},
					...
					e.exports = (t) => {
						...
						(o.each = (t, e, a, i) => {
							...
							(o.configMerge = function (e) {
								var a = o.clone(e);
								return (
									o.each(Array.prototype.slice.call(arguments, 1), (e) => {
										o.each(e, (e, i) => {
											if ("scales" === i)
												a[i] = o.scaleMerge(Object.hasOwn(a, i) ? a[i] : {}, e);
											else if ("scale" === i)
												a[i] = o.configMerge(
							...
							(o.getValueAtIndexOrDefault = (t, e, a) =>
								void 0 === t || null === t
									? a
									: o.isArray(t)
										? e < t.length
							...
							(o.max = (t) =>
								t.reduce(
									(t, e) => (isNaN(e) ? t : Math.max(t, e)),
									Number.NEGATIVE_INFINITY,
								)),
							(o.min = (t) =>
								t.reduce(
									(t, e) => (isNaN(e) ? t : Math.min(t, e)),
							...
							(o.splineCurve = (t, e, a, i) => {
								var n = t.skip ? e : t,
									o = e,
									r = a.skip ? e : a,
									l = Math.sqrt((o.x - n.x) ** 2 + (o.y - n.y) ** 2),
									s = Math.sqrt((r.x - o.x) ** 2 + (r.y - o.y) ** 2),
									d = l / (l + s),
									u = s / (l + s);
							...
							update: (t, a, i) => {
								...
								if (t) {
									var s = 0,
										...
										f = e.where(
											t.boxes,
											(t) => "bottom" === t.options.position,
										),
										g = e.where(
											t.boxes,
											(t) => "chartArea" === t.options.position,
										);
									h.sort(
										(t, e) =>
									...
									if (i.display) {
										...
										e.each(this.legendItems, (t, e) => {
											...
											k
												...
												: c + S > this.bottom &&
													((r = d.x =
														r + this.columnWidths[d.line] + n.padding),
													(c = d.y = this.top),
													d.line++),
												x(r, c, t),
												(v[e].left = r),
									...
									this.ticks = this.ticks.map(
										(e, a, i) =>
											this.options.ticks.userCallback
												...
												: this.options.ticks.callback(e, a, i),
										this,
									);
								},
								...
								draw: function (a) {
									...
									if (n.display) {
										...
										if (u.drawBorder) {
											...
											g
												? ((E = U =
														"top" === n.position ? this.bottom : this.top),
													(E += q),
													(U += q))
												: ((N = H =
														"left" === n.position ? this.right : this.left),
													(N += q),
													(H += q)),
												l.beginPath(),
												l.moveTo(N, E),
							...
							(t.Tooltip = t.Element.extend({
								...
								update: function (t) {
									...
									if (d.length) {
										...
										l.itemSort && (g = g.sort((t, e) => l.itemSort(t, e, u))),
											d.length > 1 &&
												n.each(g, (t) => {
						...
						(a.elements.arc = {
							...
							(t.elements.Arc = t.Element.extend({
								inLabelRange: function (t) {
									var e = this._view;
									return e
										? (t - e.x) ** 2 < (e.radius + e.hoverRadius) ** 2
										: !1;
								},
						...
						t.LinearScaleBase = t.Scale.extend({
							handleTickRangeOptions: function () {
								...
								void 0 !== i.min
									...
									this.min === this.max &&
										(this.max++, i.beginAtZero || this.min--);
							},
							getTickLimit: a,
									...
									(this.min = s(n.min, this.min)),
										...
										this.min === this.max &&
											(0 !== this.min && null !== this.min
												? ((this.min =
														10 ** (Math.floor(e.log10(this.min)) - 1)),
													(this.max =
														10 ** (Math.floor(e.log10(this.max)) + 1)))
											...
											? ((n = e.log10(this.end) - e.log10(r)),
												0 === l
													...
													: ((a = this.width - (u + this.paddingRight)),
														(i =
															this.left + (a / n) * (e.log10(l) - e.log10(r))),
														(i += u)))
											: ((a = this.height - (s + d)),
												0 !== r || h.reverse
													? 0 === this.end && h.reverse
														? ((n =
																e.log10(this.start) - e.log10(this.minNotZero)),
															(i =
																l === this.end
																	? this.top + s
																	: l === this.minNotZero
									...
									getValueForPixel: function (t) {
										...
										return (
											...
											this.firstTick
												.clone()
												.add(
													i.duration(n, this.tickUnit).asSeconds(),
													"seconds",
												)
										);
									},
