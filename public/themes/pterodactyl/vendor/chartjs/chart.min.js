	...
	})(
		{
					...
					(o.prototype = {
						...
						luminosity: function () {
							for (var t = this.values.rgb, e = [], a = 0; a < t.length; a++) {
								var i = t[a] / 255;
								e[a] =
									0.03928 >= i ? i / 12.92 : ((i + 0.055) / 1.055) ** 2.4;
							}
						...
						mix: function (t, e) {
							...
							return this.rgb(
								l * this.red() + s * i.red(),
								l * this.green() + s * i.green(),
								l * this.blue() + s * i.blue(),
				...
				(t, e, a) => {
					...
					function d(t) {
						...
						(e = e > 0.04045 ? ((e + 0.055) / 1.055) ** 2.4 : e / 12.92),
							...
							(i =
								i > 0.04045 ? ((i + 0.055) / 1.055) ** 2.4 : i / 12.92);
			...
			8: [
				(t, e, a) => {
					...
					e.exports = (t) => {
						t.Bar = (e, a) => ((a.type = "bar"), new t(e, a));
					};
				},
				{},
			],
			9: [
				(t, e, a) => {
					...
					e.exports = (t) => {
						t.Bubble = (e, a) => ((a.type = "bubble"), new t(e, a));
					};
				},
				{},
			],
			10: [
				(t, e, a) => {
					...
					e.exports = (t) => {
						t.Doughnut = (e, a) => ((a.type = "doughnut"), new t(e, a));
					};
				},
				{},
			],
			11: [
				(t, e, a) => {
					...
					e.exports = (t) => {
						t.Line = (e, a) => ((a.type = "line"), new t(e, a));
					};
				},
				{},
			],
			12: [
				(t, e, a) => {
					...
					e.exports = (t) => {
						t.PolarArea = (e, a) => ((a.type = "polarArea"), new t(e, a));
					};
				},
				{},
			],
					...
					e.exports = (t) => {
						var e = {
							...
							tooltips: {
								callbacks: {
									title: () => "",
									label: (t) => "(" + t.xLabel + ", " + t.yLabel + ")",
								},
							},
						};
						(t.defaults.scatter = e),
							(t.controllers.scatter = t.controllers.line),
							(t.Scatter = (e, a) => ((a.type = "scatter"), new t(e, a)));
					};
				},
				{},
			],
							...
							(t.controllers.bar = t.DatasetController.extend({
									...
									return (
										e.each(
											...
											(e, i) => {
												...
												n.bar && this.chart.isDatasetVisible(i) && ++a;
											},
											this,
										),
										a
								...
								updateElement: function (t, a, i) {
									...
									e.extend(t, {
										...
										_model: {
											...
											y: i ? s : this.calculateBarY(a, this.index),
											label: this.chart.data.labels[a],
											datasetLabel: c.label,
											base: i ? s : this.calculateBarBase(this.index, a),
								...
								getRuler: function (t) {
									...
									if (n.ticks.length !== this.chart.data.labels.length) {
										var d = n.ticks.length / this.chart.data.labels.length;
										s *= d;
									}
								...
								calculateBarX: function (t, e) {
									var 
										...
										r = this.getRuler(t),
										l = n.getPixelForValue(null, t, e, this.chart.isCombo);
									return (
										(l -= this.chart.isCombo ? r.tickWidth / 2 : 0),
										n.options.stacked
								...
								calculateBarY: function (t, e) {
									...
									if (n.options.stacked) {
										for (var r = 0, l = 0, s = 0; e > s; s++) {
											var d = this.chart.data.datasets[s],
												u = this.chart.getDatasetMeta(s);
											if (
												u.bar &&
												u.yAxisID === n.id &&
							...
							(t.controllers.horizontalBar = t.controllers.bar.extend({
								updateElement: function (t, a, i) {
									...
									e.extend(t, {
										...
										_index: a,
										_model: {
											x: i ? s : this.calculateBarX(a, this.index),
								...
								calculateBarHeight: function (t) {
									var 
										a = this.getScaleForId(this.getMeta().yAxisID);
								...
								calculateBarY: function (t, e) {
									var 
										...
										l = n.getPixelForValue(null, t, e, this.chart.isCombo);
									return (
										(l -= this.chart.isCombo ? r.tickHeight / 2 : 0),
										n.options.stacked
						...
						(t.defaults.bubble = {
							...
							(t.controllers.bubble = t.DatasetController.extend({
								...
								updateElement: function (a, i, n) {
									var 
										r = this.getMeta(),
										l = this.getScaleForId(r.xAxisID),
									...
									e.extend(a, {
										...
										_model: {
											...
											radius: n ? 0 : d.radius ? d.radius : this.getRadius(c),
								...
								setHoverStyle: function (a) {
									t.DatasetController.prototype.setHoverStyle.call(this, a);
									var n = this.chart.data.datasets[a._datasetIndex],
										o = a._index,
										r = a.custom || {},
										l = a._model;
								...
								removeHoverStyle: function (e) {
									...
									var i = this.chart.data.datasets[e._datasetIndex].data[e._index],
										n = e.custom || {},
										o = e._model;
									o.radius = n.radius ? n.radius : this.getRadius(i);
								},
							}));
					};
				},
							...
							(t.controllers.doughnut = t.controllers.pie =
								t.DatasetController.extend({
									...
									update: function (t) {
										...
										(i.borderWidth = this.getMaxBorderWidth(c.data)),
											...
											(c.total = this.calculateTotal()),
											(this.outerRadius =
												i.outerRadius -
												i.radiusLength * this.getRingIndex(this.index)),
											(this.innerRadius = this.outerRadius - i.radiusLength),
											e.each(c.data, (e, i) => {
												this.updateElement(e, i, t);
											});
									},
										...
										var 
											...
											g =
												i && s.animateRotate
													...
													: t.hidden
														? 0
														: this.calculateCircumference(f.data[a]) *
															(l.circumference / (2 * Math.PI)),
											p = i && s.animateScale ? 0 : this.innerRadius,
							...
							(t.controllers.line = t.DatasetController.extend({
								...
								addElementAndReset: function (a) {
									var 
										...
										o = this.getMeta();
									t.DatasetController.prototype.addElementAndReset.call(this, a),
										e(this.getDataset(), n) &&
								...
								updateElement: function (t, e, i) {
									var n,
										...
										c = d.data[e],
										h = this.getScaleForId(l.yAxisID),
										f = this.getScaleForId(l.xAxisID),
										g = this.chart.options.elements.point,
										p = this.chart.data.labels || [],
										m =
											1 === p.length || 1 === d.data.length || this.chart.isCombo;
									void 0 !== d.radius &&
										...
										(o = i ? h.getBasePixel() : this.calculatePointY(c, e, u)),
										(t._xScale = f),
										(t._yScale = h),
										(t._datasetIndex = u),
										(t._index = e),
								...
								draw: function (t) {
									...
									for (
										e(this.getDataset(), this.chart.options) &&
					...
					e.exports = (t) => {
						...
						(t.defaults.polarArea = {
							...
							tooltips: {
								callbacks: {
									title: () => "",
									label: (t, e) => e.labels[t.index] + ": " + t.yLabel,
								},
							},
						}),
								...
								update: function (t) {
									...
									(i.outerRadius = Math.max((s - l.borderWidth / 2) / 2, 0)),
										...
										(i.radiusLength =
											(i.outerRadius - i.innerRadius) /
											i.getVisibleDatasetCount()),
										(this.outerRadius = i.outerRadius - i.radiusLength * this.index),
										(this.innerRadius = this.outerRadius - i.radiusLength),
										(o.count = this.countVisibleElements()),
										e.each(o.data, (e, i) => {
											this.updateElement(e, i, t);
										});
								},
								updateElement: function (t, a, i) {
									for (
										var 
											...
											c = o.data.labels,
											h = this.calculateCircumference(r.data[a]),
											f = d.xCenter,
											g = d.yCenter,
											p = 0,
											m = this.getMeta(),
						...
						(t.defaults.global.animation = {
							...
							(t.animationService = {
								...
								cancelAnimation: function (t) {
									var a = e.findIndex(this.animations, (e) => e.chartInstance === t);
									-1 !== a &&
										(this.animations.splice(a, 1), (t.animating = !1));
								},
								requestAnimationFrame: function () {
									null === this.request &&
										(this.request = e.requestAnimFrame.call(window, () => {
											(this.request = null), this.startDigest();
										}));
								},
					...
					e.exports = (t) => {
						...
						(t.types = {}),
							...
							e.extend(t.Controller.prototype, {
								initialize: function () {
									return (
										t.plugins.notify("beforeInit", [this]),
										this.bindEvents(),
										...
										this.initToolTip(),
										this.update(),
										t.plugins.notify("afterInit", [this]),
										this
									);
								},
								clear: function () {
								...
								resize: function (a) {
									...
									return (
										t.plugins.notify("resize", [this, u]),
										this.options.onResize && this.options.onResize(this, u),
										a ||
											(this.stop(),
								...
								buildScales: function () {
									...
									i.scales &&
										(o = o.concat(
											(i.scales.xAxes || []).map((t) => ({ options: t, dtype: "category" })),
											(i.scales.yAxes || []).map((t) => ({ options: t, dtype: "linear" })),
										)),
										i.scale &&
											o.push({
												options: i.scale,
										...
										e.each(o, (i) => {
											...
											if (l) {
												...
												(n[s.id] = s), i.isDefault && (this.scale = s);
											}
										}),
								...
								buildOrUpdateControllers: function () {
									...
									if (
										(e.each(
											this.data.datasets,
											(e, o) => {
												var r = this.getDatasetMeta(o);
												r.type || (r.type = e.type || this.config.type),
													i.push(r.type),
													r.controller
														? r.controller.updateIndex(o)
														: ((r.controller = new t.controllers[r.type](this, o)),
															n.push(r.controller));
											},
											this,
										),
								...
								update: function (a, i) {
									t.plugins.notify("beforeUpdate", [this]),
									...
									e.each(
										...
										t.plugins.notify("afterScaleUpdate", [this]),
										e.each(o, (t) => {
											t.reset();
										}),
										this.updateDatasets(),
										t.plugins.notify("afterUpdate", [this]),
										this.render(a, i);
								},
								updateDatasets: function () {
									var e,
										a;
									if (t.plugins.notify("beforeDatasetsUpdate", [this])) {
										for (e = 0, a = this.data.datasets.length; a > e; ++e)
											this.getDatasetMeta(e).controller.update();
										t.plugins.notify("afterDatasetsUpdate", [this]);
									}
								},
								render: function (a, i) {
									t.plugins.notify("beforeRender", [this]);
									...
									if (
										...
										(r.numSteps = (a || o.duration) / 16.66),
											...
											t.animationService.addAnimation(this, r, a, i);
									} else
										this.draw(),
											o &&
												o.onComplete &&
								...
								draw: function (a) {
									var 
										n = a || 1;
									this.clear(),
										t.plugins.notify("beforeDraw", [this, n]),
										e.each(
											this.boxes,
											(t) => {
										...
										t.plugins.notify("beforeDatasetsDraw", [this, n]),
										e.each(
											this.data.datasets,
											(t, e) => {
												this.isDatasetVisible(e) &&
													this.getDatasetMeta(e).controller.draw(a);
											},
											this,
											!0,
										),
										t.plugins.notify("afterDatasetsDraw", [this, n]),
										this.tooltip.transition(n).draw(),
										t.plugins.notify("afterDraw", [this, n]);
								},
								getElementAtEvent: function (t) {
									var 
										i = e.getRelativePosition(t, this.chart),
										n = [];
									return (
										e.each(this.data.datasets, (t, o) => {
											if (this.isDatasetVisible(o)) {
												var r = this.getDatasetMeta(o);
												e.each(r.data, (t) => t.inRange(i.x, i.y) ? (n.push(t), n) : void 0);
											}
										}),
										n.slice(0, 1)
									);
										...
										? (e.each(
												...
												(t, i) => {
													if (this.isDatasetVisible(i)) {
														var r = this.getDatasetMeta(i),
															l = e.findIndex(r.data, (t) => o._model.x === t._model.x);
														-1 === l ||
															r.data[l]._view.skip ||
															n.push(r.data[l]);
													}
								...
								getDatasetMeta: function (t) {
									var 
										a = this.data.datasets[t];
									a._meta || (a._meta = {});
									var i = a._meta[this.id];
									return (
										i ||
											(i = a._meta[this.id] =
												{
								...
								bindEvents: function () {
									e.bindEvents(this, this.options.events, (e) => {
										this.eventHandler(e);
									});
								},
								...
								eventHandler: function (t) {
									...
									return (
										...
										"mouseout" === t.type
											...
											: ((this.active = this.getElementsAtEventForMode(t, o.mode)),
												(this.tooltipActive = this.getElementsAtEventForMode(
													t,
													r.mode,
												))),
										o.onHover && o.onHover.call(this, this.active),
										this.legend && this.legend.handleEvent && this.legend.handleEvent(t),
										("mouseup" === t.type || "click" === t.type) &&
											n.onClick &&
											n.onClick.call(this, t, this.active),
										this.lastActive.length &&
											this.updateHoverStyle(this.lastActive, o.mode, !1),
										this.active.length &&
											o.mode &&
											this.updateHoverStyle(this.active, o.mode, !0),
										(r.enabled || r.custom) &&
											(i.initialize(),
											(i._active = this.tooltipActive),
											i.update(!0)),
										i.pivot(),
										this.animating ||
											(e.arrayEquals(this.active, this.lastActive) &&
												e.arrayEquals(this.tooltipActive, this.lastTooltipActive)) ||
											(this.stop(),
											(r.enabled || r.custom) && i.update(!0),
											this.render(o.animationDuration, !0)),
						...
						(t.DatasetController = function (t, e) {
							...
							e.extend(t.DatasetController.prototype, {
								...
								linkScales: function () {
									...
									null === e.xAxisID &&
										(e.xAxisID =
											a.xAxisID || this.chart.options.scales.xAxes[0].id),
										null === e.yAxisID &&
											(e.yAxisID =
								...
								createMetaDataset: function () {
									var 
										e = this.datasetElementType;
									return (
										e &&
										new e({ _chart: this.chart.chart, _datasetIndex: this.index })
									);
								},
								createMetaData: function (t) {
									var 
										a = this.dataElementType;
									return (
										a &&
										new a({
								...
								addElements: function () {
									...
									for (t = 0, e = n.length; e > t; ++t)
										o[t] = o[t] || this.createMetaData(i, t);
									i.dataset = i.dataset || this.createMetaDataset();
								},
								addElementAndReset: function (t) {
									var 
										a = this.createMetaData(t);
									this.getMeta().data.splice(t, 0, a), this.updateElement(a, t, !0);
								},
										...
										1 === t
											...
											: (this._start || this.pivot(),
												e.each(
													...
													(i, n) => {
														if ("_" === n[0]);
														else if (Object.hasOwn(this._view, n))
															if (i === this._view[n]);
															else if ("string" == typeof i)
																try {
																	var o = e
																		.color(this._model[n])
																		.mix(e.color(this._start[n]), t);
																...
																var l =
																	...
																	isNaN(this._start[n]) === !1
																		? this._start[n]
																		: 0;
																this._view[n] = (this._model[n] - l) * t + l;
															} else this._view[n] = i;
														else
															"number" != typeof i || isNaN(this._view[n])
																? (this._view[n] = i)
																: (this._view[n] = i * t);
													},
													this,
				...
				(t, e, a) => {
					...
					e.exports = (t) => {
						...
						(o.each = (t, e, a, i) => {
							...
							(o.getValueAtIndexOrDefault = (t, e, a) => void 0 === t || null === t
									? a
									: o.isArray(t)
										? e < t.length
											? t[e]
											: a
										: t),
							(o.getValueOrDefault = (t, e) => void 0 === t ? e : t),
							...
							(o.isNumber = (t) => !isNaN(parseFloat(t)) && isFinite(t)),
							(o.almostEquals = (t, e, a) => Math.abs(t - e) < a),
							(o.max = (t) => t.reduce((t, e) => isNaN(e) ? t : Math.max(t, e), Number.NEGATIVE_INFINITY)),
							(o.min = (t) => t.reduce((t, e) => isNaN(e) ? t : Math.min(t, e), Number.POSITIVE_INFINITY)),
							(o.sign = Math.sign
								? ((t) => Math.sign(t))
								: ((t) => ((t = +t), 0 === t || isNaN(t) ? t : t > 0 ? 1 : -1))),
							(o.log10 = Math.log10
								? ((t) => Math.log10(t))
								: ((t) => Math.log(t) / Math.LN10)),
							(o.toRadians = (t) => t * (Math.PI / 180)),
							(o.toDegrees = (t) => t * (180 / Math.PI)),
							(o.getAngleFromPoint = (t, e) => {
								var a = e.x - t.x,
									i = e.y - t.y,
									n = Math.sqrt(a * a + i * i),
									o = Math.atan2(i, a);
							...
							(o.aliasPixel = (t) => t % 2 === 0 ? 0 : 0.5),
							(o.splineCurve = (t, e, a, i) => {
								var n = t.skip ? e : t,
									o = e,
									r = a.skip ? e : a,
									l = Math.sqrt(
						...
						var r = (o.easingEffects = {
							...
							easeInExpo: (t) => 0 === t ? 1 : 1 * 2 ** (10 * (t / 1 - 1)),
							easeOutExpo: (t) => 1 === t ? 1 : 1 * (-(2 ** ((-10 * t) / 1)) + 1),
							easeInOutExpo: (t) => 0 === t
									? 0
									: 1 === t
										? 1
							...
							easeInBounce: (t) => 1 - r.easeOutBounce(1 - t),
							easeOutBounce: (t) => (t /= 1) < 1 / 2.75
									? 1 * (7.5625 * t * t)
									: 2 / 2.75 > t
						...
						(o.requestAnimFrame = (() => (
							...
							(o.getConstraintWidth = (t) => n(t, "max-width", "clientWidth")),
							(o.getConstraintHeight = (t) => n(t, "max-height", "clientHeight")),
							(o.getMaximumWidth = (t) => {
								var e = t.parentNode,
							...
							(o.fontString = (t, e, a) => e + " " + t + "px " + a),
							(o.longestText = (t, e, a, i) => {
								i = i || {};
								var n = (i.data = i.data || {}),
							...
							(o.drawRoundedRectangle = (t, e, a, i, n, o) => {
								t.beginPath(),
									t.moveTo(e + o, a),
									t.lineTo(e + i - o, a),
							...
							(o.addResizeListener = (t, e) => {
								...
								(n.width = "100%"),
									...
									((a.contentWindow || a).onresize = () => e ? e() : void 0);
							}),
							(o.removeResizeListener = (t) => {
							...
							(o.callCallback = (t, e, a) => {
								t && "function" == typeof t.call && t.apply(a, e);
							}),
							(o.getHoverColor = (t) => t instanceof CanvasPattern
									? t
					...
					e.exports = () => {
						var t = function (e, a) {
							...
							return (
								...
								n.retinaScale(this),
								(this.controller = new t.Controller(this)),
								n.addResizeListener(e.canvas.parentNode, () => {
									this.controller &&
										this.controller.config.options.responsive &&
					...
					e.exports = (t) => {
						...
						t.layoutService = {
							...
							update: (t, a, i) => {
								...
								function o(t) {
									var a = e.findNextWhere(w, (e) => e.box === t);
									if (a)
										if (t.isHorizontal()) {
								...
								if (t) {
									var s = 0,
										d = 0,
										u = e.where(t.boxes, (t) => "left" === t.options.position),
										c = e.where(t.boxes, (t) => "right" === t.options.position),
										h = e.where(t.boxes, (t) => "top" === t.options.position),
										f = e.where(t.boxes, (t) => "bottom" === t.options.position),
										g = e.where(t.boxes, (t) => "chartArea" === t.options.position);
									h.sort((t, e) => (
						...
						(t.defaults.global.legend = {
							...
							(t.Legend = t.Element.extend({
								...
								fit: function () {
									...
									if (
										(p
											? ((g.width = this.maxWidth), (g.height = o ? 10 : 0))
											: ((g.width = o ? 10 : 0), (g.height = this.maxHeight)),
										o)
									)
										if (((r.font = h), p)) {
											var m = (this.lineWidths = [0]),
												b = this.legendItems.length ? d + n.padding : 0;
											(r.textAlign = "left"),
												(r.textBaseline = "top"),
												e.each(this.legendItems, (t, e) => {
													var i = n.usePointStyle
															? d * Math.sqrt(2)
															: n.boxWidth,
														o = i + d / 2 + r.measureText(t.text).width;
													m[m.length - 1] + o + n.padding >= this.width &&
														((b += d + n.padding), (m[m.length] = this.left)),
										...
										e.each(this.legendItems, (t, e) => {
											...
											k
												? r + o >= l &&
													((c = d.y += S),
													d.line++,
													(r = d.x = this.left + (l - s[d.line]) / 2))
												: c + S > this.bottom &&
													((r = d.x = r + this.columnWidths[d.line] + n.padding),
													(c = d.y = this.top),
													d.line++),
												x(r, c, t),
												(v[e].left = r),
								...
								handleEvent: function (t) {
									...
									var o = e.getRelativePosition(t, this.chart.chart),
										r = o.x,
										l = o.y;
									if (
										r >= this.left &&
										...
										for (var s = this.legendHitBoxes, d = 0; d < s.length; ++d) {
											var u = s[d];
											if (
												r >= u.left &&
												r <= u.left + u.width &&
												...
												if ("click" === n) {
													i.onClick.call(this, t, this.legendItems[d]);
													break;
												}
												if ("mousemove" === n) {
													i.onHover.call(this, t, this.legendItems[d]);
													break;
												}
											}
										}
						...
						(t.defaults.scale = {
							...
							(t.Scale = t.Element.extend({
								...
								convertTicksToLabels: function () {
									this.ticks = this.ticks.map((e, a, i) => this.options.ticks.userCallback
											? this.options.ticks.userCallback(e, a, i)
											: this.options.ticks.callback(e, a, i), this);
								},
								...
								calculateTickRotation: function () {
									...
									i.font = d;
									var u,
										c = i.measureText(this.ticks[0]).width,
										h = i.measureText(this.ticks[this.ticks.length - 1]).width;
									if (
										...
										(this.paddingRight = h / 2 + 3),
											(this.paddingLeft = c / 2 + 3),
											this.longestTextCache || (this.longestTextCache = {});
										for (
											var f,
												g,
												p = e.longestText(i, d, this.ticks, this.longestTextCache),
												m = p,
												b = this.getPixelForTick(1) - this.getPixelForTick(0) - 6;
											m > b && this.labelRotation < o.maxRotation;
										) {
											if (
												((f = Math.cos(e.toRadians(this.labelRotation))),
												(g = Math.sin(e.toRadians(this.labelRotation))),
												(u = f * c),
												u + r / 2 > this.yLabelWidth &&
													(this.paddingLeft = u + r / 2),
												(this.paddingRight = r / 2),
												g * p > this.maxHeight)
											) {
												this.labelRotation--;
												break;
											}
											this.labelRotation++, (m = f * p);
										}
									}
									this.margins &&
								...
								fit: function () {
									var 
										i = (this.minSize = { width: 0, height: 0 }),
										n = this.options,
										o = t.defaults.global,
										r = n.ticks,
										l = n.scaleLabel,
									...
									if (
										...
										var b = e.longestText(
											...
											v = e.numberOfLabelLines(this.ticks),
											x = 0.5 * c;
										if (u) {
											...
											var y =
												...
												c * v +
												x * v;
											(i.height = Math.min(this.maxHeight, i.height + y)),
												(this.ctx.font = g);
											var k = this.ctx.measureText(this.ticks[0]).width,
											...
											(this.paddingLeft =
												0 !== this.labelRotation ? w * k + 3 : k / 2 + 3),
												(this.paddingRight =
													0 !== this.labelRotation ? C * (c / 2) + 3 : S / 2 + 3);
										} else {
											var M = this.maxWidth - i.width,
												D = r.mirror;
											D ? (b = 0) : (b += this.options.ticks.padding),
												M > b ? (i.width += b) : (i.width = this.maxWidth),
												(this.paddingTop = c / 2),
									...
									if (n.display) {
										...
										if (g) {
											if (
												((o = !1),
												h && (P /= 2),
												(P + d.autoSkipPadding) * this.ticks.length >
										...
										var R = "right" === n.position ? this.left : this.right - y,
											_ = "right" === n.position ? this.left + y : this.right,
											V = "bottom" === n.position ? this.top : this.bottom - y,
											L = "bottom" === n.position ? this.top + y : this.bottom;
										if (
											(e.each(this.ticks, (t, r) => {
												if (void 0 !== t && null !== t) {
													var l = this.ticks.length === r + 1,
														s =
															(o > 1 && r % o > 0) ||
															(r % o === 0 && r + o >= this.ticks.length);
													if ((!s || l) && void 0 !== t && null !== t) {
														...
														if (g) {
															h ||
																...
																(T = h ? "right" : "center");
															var O = this.getPixelForTick(r) + e.aliasPixel(c);
															(D =
																this.getPixelForTick(r, u.offsetGridLines) +
																d.labelOffset),
																(I = h
																	? this.top + 12
																	: "top" === n.position
															...
															"left" === n.position
																? d.mirror
																	? ((D = this.right + d.padding), (T = "left"))
																	: ((D = this.right - d.padding), (T = "right"))
																: d.mirror
																	? ((D = this.left - d.padding), (T = "right"))
																	: ((D = this.left + d.padding), (T = "left"));
															var B = this.getPixelForTick(r);
															(B += e.aliasPixel(c)),
																(I = this.getPixelForTick(r, u.offsetGridLines)),
																(p = R),
																(b = _),
																(x = a.left),
																(C = a.right),
											...
											if (g)
												...
												(O = z ? this.left + C / 2 : this.right - C / 2),
													(B = this.top + (this.bottom - this.top) / 2),
										...
										if (u.drawBorder) {
											...
											g
												? ((E = U = "top" === n.position ? this.bottom : this.top),
													(E += q),
													(U += q))
												: ((N = H = "left" === n.position ? this.right : this.left),
													(N += q),
													(H += q)),
												l.beginPath(),
												l.moveTo(N, E),
					...
					e.exports = (t) => {
						...
						t.scaleService = {
							...
							getScaleConstructor: function (t) {
								return  Object.hasOwn(this.constructors, t)
									? this.constructors[t]
									: void 0;
							},
							getScaleDefaults: function (a) {
								return  Object.hasOwn(this.defaults, a)
									? e.scaleMerge(t.defaults.scale, this.defaults[a])
									: {};
							},
							updateScaleDefaults: function (t, a) {
								var i = this.defaults;
								Object.hasOwn(i, t) && (i[t] = e.extend(i[t], a));
							},
							addScalesToLayout: (a) => {
								e.each(a.scales, (e) => {
							...
							(t.Tooltip = t.Element.extend({
								...
								getTitle: function () {
									var 
										a = this._options,
										i = a.callbacks,
										n = i.beforeTitle.apply(this, arguments),
										o = i.title.apply(this, arguments),
										r = i.afterTitle.apply(this, arguments),
										l = [];
								...
								getBody: function (t, a) {
									var 
										o = this._options.callbacks,
										r = [];
									return (
										n.each(t, (t) => {
											var n = { before: [], lines: [], after: [] };
											e(n.before, o.beforeLabel.call(this, t, a)),
												e(n.lines, o.label.call(this, t, a)),
												e(n.after, o.afterLabel.call(this, t, a)),
												r.push(n);
										}),
										r
									);
								...
								getFooter: function () {
									var 
										a = this._options.callbacks,
										i = a.beforeFooter.apply(this, arguments),
										n = a.footer.apply(this, arguments),
										o = a.afterFooter.apply(this, arguments),
										r = [];
								...
								update: function (t) {
									...
									if (d.length) {
										...
										l.itemSort &&
											(g = g.sort((t, e) => l.itemSort(t, e, u))),
											d.length > 1 &&
												n.each(g, (t) => {
													h.push(l.callbacks.labelColor.call(this, t, c));
												}),
											n.extend(s, {
												title: this.getTitle(g, u),
												beforeBody: this.getBeforeBody(g, u),
												body: this.getBody(g, u),
												afterBody: this.getAfterBody(g, u),
												footer: this.getFooter(g, u),
												x: Math.round(f.x),
												y: Math.round(f.y),
												caretPadding: n.getValueOrDefault(f.padding, 2),
												labelColors: h,
											});
										var p = this.getTooltipSize(s);
										this.determineAlignment(p),
											n.extend(s, this.getBackgroundPoint(s, p));
									} else this._model.opacity = 0;
									return t && l.custom && l.custom.call(this, s), this;
								},
								...
								determineAlignment: function (t) {
									...
									"center" === a.yAlign
										? ((o = (t) => u >= t),
											(r = (t) => t > u))
										: ((o = (e) => e <= t.width / 2),
											(r = (e) => e >= i.width - t.width / 2)),
										(l = (e) => e + t.width > i.width),
										(s = (e) => e - t.width < 0),
										(d = (t) => c >= t ? "top" : "bottom"),
										o(a.x)
											? ((a.xAlign = "left"),
						...
						(a.elements.point = {
							...
							(t.elements.Point = t.Element.extend({
								inRange: function (t, e) {
									...
									return a
										? (t - a.x) ** 2 + (e - a.y) ** 2 <
												(a.hitRadius + a.radius) ** 2
										: !1;
								},
								inLabelRange: function (t) {
									var e = this._view;
									return e
										? (t - e.x) ** 2 < (e.radius + e.hitRadius) ** 2
										: !1;
								},
								tooltipPosition: function () {
									var t = this._view;
						...
						var e = t.helpers,
							...
							i = t.Scale.extend({
								...
								determineDataLimits: function () {
									var 
										a = this.getLabels();
									(this.minIndex = 0), (this.maxIndex = a.length - 1);
									var i;
									void 0 !== this.options.ticks.min &&
										((i = e.indexOf(a, this.options.ticks.min)),
										(this.minIndex = -1 !== i ? i : this.minIndex)),
										void 0 !== this.options.ticks.max &&
											((i = e.indexOf(a, this.options.ticks.max)),
											(this.maxIndex = -1 !== i ? i : this.maxIndex)),
										(this.min = a[this.minIndex]),
										(this.max = a[this.maxIndex]);
								},
								buildTicks: function () {
									var 
										e = this.getLabels();
								...
								getPixelForValue: function (t, e, a, i) {
									...
									if (this.isHorizontal()) {
										var s = this.width - (this.paddingLeft + this.paddingRight),
											d = s / o,
											u = d * (e - this.minIndex) + this.paddingLeft;
										return (
											((this.options.gridLines.offsetGridLines && i) ||
												(this.maxIndex === this.minIndex && i)) &&
												(u += d / 2),
									...
									var c = this.height - (this.paddingTop + this.paddingBottom),
										h = c / o,
										f = h * (e - this.minIndex) + this.paddingTop;
									return (
										this.options.gridLines.offsetGridLines && i && (f += h / 2),
										this.top + Math.round(f)
									);
								},
								getPixelForTick: function (t, e) {
									return this.getPixelForValue(
								...
								getValueForPixel: function (t) {
									...
									return (
										...
										this.options.gridLines.offsetGridLines && (t -= r / 2),
							...
							i = t.LinearScaleBase.extend({
								determineDataLimits: function () {
									...
									var 
										...
										r = o.datasets,
										l = this.isHorizontal();
									if (((this.min = null), (this.max = null), i.stacked)) {
										var s = {};
										e.each(r, (o, r) => {
											...
											e.each(s, (t) => {
												var i = t.positiveValues.concat(t.negativeValues),
													n = e.min(i),
													o = e.max(i);
												(this.min = null === this.min ? n : Math.min(this.min, n)),
													(this.max = null === this.max ? o : Math.max(this.max, o));
											});
									} else
										e.each(r, (i, o) => {
								...
								getPixelForValue: function (t) {
									var e,
										...
										r = this.start,
										l = +this.getRightValue(t),
										s = this.end - r;
									return this.isHorizontal()
										? ((a = this.width - (n + this.paddingRight)),
											(e = this.left + (a / s) * (l - r)),
											Math.round(e + n))
										: ((a = this.height - (this.paddingTop + o)),
											(e = this.bottom - o - (a / s) * (l - r)),
											Math.round(e));
								},
								getValueForPixel: function (t) {
									var 
										a = this.isHorizontal(),
										i = this.paddingLeft,
										n = this.paddingBottom,
										o = a
											? this.width - (i + this.paddingRight)
											: this.height - (this.paddingTop + n),
										r = (a ? t - this.left - i : this.bottom - n - t) / o;
						...
						t.LinearScaleBase = t.Scale.extend({
							handleTickRangeOptions: function () {
								var 
									...
									i = a.ticks;
								if (i.beginAtZero) {
									var n = e.sign(this.min),
										o = e.sign(this.max);
									0 > n && 0 > o ? (this.max = 0) : n > 0 && o > 0 && (this.min = 0);
								}
								void 0 !== i.min
									? (this.min = i.min)
									: void 0 !== i.suggestedMin &&
										(this.min = Math.min(this.min, i.suggestedMin)),
									void 0 !== i.max
										? (this.max = i.max)
										: void 0 !== i.suggestedMax &&
											(this.max = Math.max(this.max, i.suggestedMax)),
									this.min === this.max && (this.max++, i.beginAtZero || this.min--);
							},
							getTickLimit: a,
							...
							buildTicks: function () {
								...
								if (s) l = o(n.fixedStepSize, n.stepSize);
									...
									var d = e.niceNum(this.max - this.min, !1);
									l = e.niceNum(d / (r - 1), !0);
								}
								var u = Math.floor(this.min / l) * l,
									c = Math.ceil(this.max / l) * l,
									h = (c - u) / l;
					...
					e.exports = (t) => {
						var e = t.helpers,
							a = {
								...
								ticks: {
									callback: (t, a, i) => {
										var n = t / 10 ** Math.floor(e.log10(t));
										return 0 === t
											? "0"
											: 1 === n ||
													2 === n ||
							...
							i = t.Scale.extend({
									...
									if (
										...
										e.each(l, (n, r) => {
											...
											e.each(u, (t) => {
												var i = e.min(t),
													n = e.max(t);
												(this.min = null === this.min ? i : Math.min(this.min, i)),
													(this.max = null === this.max ? n : Math.max(this.max, n));
											});
									} else
										e.each(l, (i, n) => {
												...
												e.each(i.data, (t, e) => {
													...
													isNaN(i) ||
														...
														null === this.max
															...
															: i > this.max && (this.max = i),
														0 !== i &&
															(null === this.minNotZero || i < this.minNotZero) &&
															(this.minNotZero = i));
												});
										});
									(this.min = s(n.min, this.min)),
										(this.max = s(n.max, this.max)),
										this.min === this.max &&
								...
								buildTicks: function () {
									for (
										var 
											...
											n = e.getValueOrDefault,
											o = (this.ticks = []),
											r = n(i.min, 10 ** Math.floor(e.log10(this.min)));
										r < this.max;
									) {
										o.push(r);
										var l, s;
										0 === r
											? ((l = Math.floor(e.log10(this.minNotZero))),
												(s = Math.round(this.minNotZero / 10 ** l)))
											: ((l = Math.floor(e.log10(r))),
												(s = Math.floor(r / 10 ** l) + 1)),
											10 === s && ((s = 1), ++l),
											(r = s * 10 ** l);
									}
									var d = n(i.max, r);
									o.push(d),
										this.isHorizontal() || o.reverse(),
										(this.max = e.max(o)),
										(this.min = e.min(o)),
										i.reverse
								...
								getPixelForValue: function (t) {
									...
									return (
										this.isHorizontal()
											? ((n = e.log10(this.end) - e.log10(r)),
												0 === l
													? (i = this.left + u)
													: ((a = this.width - (u + this.paddingRight)),
														(i = this.left + (a / n) * (e.log10(l) - e.log10(r))),
														(i += u)))
											: ((a = this.height - (s + d)),
												0 !== r || h.reverse
													? 0 === this.end && h.reverse
														? ((n = e.log10(this.start) - e.log10(this.minNotZero)),
															(i =
																l === this.end
																	? this.top + s
																	: l === this.minNotZero
																		...
																		: this.top +
																			...
																			0.02 * a +
																			((0.98 * a) / n) *
																				(e.log10(l) - e.log10(this.minNotZero))))
														: ((n = e.log10(this.end) - e.log10(r)),
															(a = this.height - (s + d)),
															(i =
																this.bottom -
													...
													: ((n = e.log10(this.end) - e.log10(this.minNotZero)),
														(i =
															l === r
																? this.bottom - d
																: l === this.minNotZero
																	? this.bottom - d - 0.02 * a
																	: this.bottom -
																		d -
																		0.02 * a -
																		((0.98 * a) / n) *
								...
								getValueForPixel: function (t) {
									var a,
										i,
										o = e.log10(this.end) - e.log10(this.start);
									return (
										this.isHorizontal()
											? ((i = this.width - (this.paddingLeft + this.paddingRight)),
												(a =
													this.start *
													10 ** (((t - this.left - this.paddingLeft) * o) / i)))
											: ((i = this.height - (this.paddingTop + this.paddingBottom)),
												(a =
													
														10 ** (
														((this.bottom - this.paddingBottom - t) * o) / i)
													 / this.start)),
										a
									);
								},
						...
						var e = t.helpers,
							...
							n = t.LinearScaleBase.extend({
								...
								setDimensions: function () {
									...
									var o = e.min([this.height, this.width]),
										r = e.getValueOrDefault(n.fontSize, a.defaultFontSize);
									this.drawingArea = i.display
								...
								determineDataLimits: function () {
									...
									(this.min = null),
										(this.max = null),
										e.each(a.data.datasets, (i, n) => {
											if (a.isDatasetVisible(n)) {
												var o = a.getDatasetMeta(n);
												e.each(i.data, (e, a) => {
													var i = +this.getRightValue(e);
													isNaN(i) ||
														o.data[a].hidden ||
														(null === this.min
															? (this.min = i)
								...
								setCenterPoint: function (t, e) {
									var 
										i = this.width - e - this.drawingArea,
								...
								draw: function () {
									...
									if (i.display) {
										...
										if (
											(e.each(this.ticks, (r, l) => {
												if (l > 0 || i.reverse) {
													var c = this.getDistanceFromCenterForValue(
															this.ticksAsNumbers[l],
														),
														h = this.yCenter - c;
													if (n.display && 0 !== l)
														if (
															...
															d.beginPath(),
																d.arc(this.xCenter, this.yCenter, c, 0, 2 * Math.PI),
																d.closePath(),
																d.stroke();
														else {
															d.beginPath();
															for (var g = 0; g < this.getValueCount(); g++) {
																var p = this.getPointPosition(g, c);
																0 === g
																	? d.moveTo(p.x, p.y)
																	: d.lineTo(p.x, p.y);
															}
													...
													if (o.display) {
														...
														if (((d.font = f), o.showLabelBackdrop)) {
															...
															(d.fillStyle = o.backdropColor),
																d.fillRect(
																	this.xCenter - b / 2 - o.backdropPaddingX,
											...
											for (
												var g = this.getDistanceFromCenterForValue(
														i.reverse ? this.min : this.max,
													),
													p = s(l.fontSize, a.defaultFontSize),
													m = s(l.fontStyle, a.defaultFontStyle),
													b = s(l.fontFamily, a.defaultFontFamily),
													v = e.fontString(p, m, b),
													x = this.getValueCount() - 1;
												x >= 0;
												x--
											) {
												if (r.display) {
													var y = this.getPointPosition(x, g);
													d.beginPath(),
								...
								o = t.Scale.extend({
									...
									getLabelDiff: function (t, e) {
										return null === t || null === e
											...
											: (void 0 === this.labelDiffs && this.buildLabelDiffs(),
												"undefined" != typeof this.labelDiffs[t]
													? this.labelDiffs[t][e]
													: null);
									},
									...
									determineDataLimits: function () {
										...
										this.chart.data.labels && this.chart.data.labels.length > 0
											? (e.each(
												...
												(this.firstTick = i.min.call(this, a)),
												(this.lastTick = i.max.call(this, a)))
											: ((this.firstTick = null), (this.lastTick = null)),
											e.each(
												this.chart.data.datasets,
												(n, o) => {
													var r = [],
														l = this.chart.isDatasetVisible(o);
																...
																(e) => {
																	...
																	a.isValid() &&
																		...
																		l &&
																			((this.firstTick =
																				null !== this.firstTick
																					? i.min(this.firstTick, a)
																					: a),
																			(this.lastTick =
																				null !== this.lastTick
																					? i.max(this.lastTick, a)
																					: a)));
																},
																this,
															)
														: (r = a),
														this.labelMoments.push(r);
												},
												this,
											),
											...
											(this.firstTick = (this.firstTick || i()).clone()),
											(this.lastTick = (this.lastTick || i()).clone());
									},
											...
											e.each(
												...
												(e) => {
													...
													i.isValid() &&
														(this.options.time.round &&
															i.startOf(this.options.time.round),
														a.push(i.diff(this.firstTick, this.tickUnit, !0)));
												},
												this,
											),
											e.each(
																...
																(e) => {
																	...
																	a.isValid() &&
																		(this.options.time.round &&
																			a.startOf(this.options.time.round),
																		n.push(
																			a.diff(this.firstTick, this.tickUnit, !0),
																		));
																},
																this,
															)
														: (n = a),
														this.labelDiffs.push(n);
												},
												this,
											);
									},
									buildTicks: function () {
										...
										if (
											...
											var s = this.isHorizontal()
													? this.width - (this.paddingLeft + this.paddingRight)
													: this.height - (this.paddingTop + this.paddingBottom),
												d = this.tickFormatFunction(this.firstTick, 0, []),
											...
											for (var g = 0, p = a.units[g]; g < a.units.length; ) {
												...
												++g, (p = a.units[g]), (this.tickUnit = p.name);
										...
										if (
											...
											var y = this.getMomentStartOf(this.lastTick),
												k = y.diff(this.lastTick, this.tickUnit, !0);
											0 > k
										...
										for (var S = 1; S <= this.scaleSizeInUnits; ++S) {
											var w = x.clone().add(S, this.tickUnit);
											if (
												this.options.time.max &&
												w.diff(this.lastTick, this.tickUnit, !0) >= 0
											)
												break;
											S % this.unitScale === 0 && this.ticks.push(w);
										}
									...
									getLabelForIndex: function (t, e) {
										...
										return (
											...
											this.options.time.tooltipFormat &&
												(i = this
													.parseTime(i)
													.format(this.options.time.tooltipFormat)),
											i
										);
									},
									...
									getPixelForValue: function (t, e, a) {
										...
										if (
											(void 0 !== e &&
												void 0 !== a &&
												(n = this.getLabelDiff(a, e)),
											null === n &&
												((t && t.isValid) ||
													(t = this.parseTime(this.getRightValue(t))),
												t &&
													t.isValid &&
													t.isValid() &&
													(n = t.diff(this.firstTick, this.tickUnit, !0))),
											null !== n)
										) {
											var o = 0 !== n ? n / this.scaleSizeInUnits : n;
											if (this.isHorizontal()) {
												var r = this.width - (this.paddingLeft + this.paddingRight),
													l = r * o + this.paddingLeft;
												return this.left + Math.round(l);
											}
											var s = this.height - (this.paddingTop + this.paddingBottom),
												d = s * o + this.paddingTop;
									...
									getValueForPixel: function (t) {
										var 
											...
											n =
												...
												a;
										return (
											(n *= this.scaleSizeInUnits),
											this.firstTick
												.clone()
												.add(i.duration(n, this.tickUnit).asSeconds(), "seconds")
										);
									},
									parseTime: function (t) {
										return "string" == typeof this.options.time.parser
											? i(t, this.options.time.parser)
